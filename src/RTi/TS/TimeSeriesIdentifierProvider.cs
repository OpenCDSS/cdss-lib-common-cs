...
namespace RTi.TS
{
	...
	public interface TimeSeriesIdentifierProvider
	{
		...
		/// exception type is not required. </summary>
		/// <param name="pos"> position (0+), used to retrieve identifier from a set, sequence, etc. </param>
		TSIdent getTimeSeriesIdentifier(int pos);
	}
