...
namespace RTi.TS
{
	...
	/// @author sam </summary>
	/// <seealso cref= TSUtil.getTSFormatSpecifiers </seealso>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("serial") public class TSFormatSpecifiersJPanel extends javax.swing.JPanel implements java.awt.event.ItemListener
	public class TSFormatSpecifiersJPanel : JPanel, ItemListener
	{
		/// <summary>
		/// Hint to aid user.
		/// </summary>
		...
		public TSFormatSpecifiersJPanel(int width)
		{
			...
			IList<string> choicesList = StringUtil.toList(TSUtil.getTSFormatSpecifiers(true));
