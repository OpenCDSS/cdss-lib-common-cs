...
namespace RTi.GRTS
{
	...
	/// <summary>
	/// Returns a name of the DMI that is suitable for use in dialogs and window titles. </summary>
	/// <returns> the name of the DMI. </returns>
	string getDMIName();
	...
	/// </summary>
	System.Collections.IList readTSProductDMITSProductList(bool newProduct);

	/// <summary>
	/// Writes the specified TSProduct.  The classes that implements this interface is
	/// responsible for deciding how the product should be written. </summary>
	/// <param name="tsproduct"> the TSProduct to write. </param>
	bool writeTSProduct(TSProduct tsproduct);
