...
namespace RTi.GR
{
	...
	/// </summary>
	public const int CAP_BUTT = 1;
	/// <summary>
	/// Lines will have projecting end.
	/// </summary>
	public const int CAP_PROJECT = 2;
	/// <summary>
	/// Lines will have round end.
	/// </summary>
	public const int CAP_ROUND = 3;

	/// <summary>
	/// Fill arc across chord.
	/// </summary>
	public const int FILL_CHORD = 1;
	/// <summary>
	/// Fill arc like a pie.
	/// </summary>
	public const int FILL_PIE = 2;
	...
	/// </summary>
	private static double[] __sxm = new double[4], __sym = new double[4];

	/// <summary>
	/// Print a comment to the output (generally only useful for hard-copy devices).
	/// This should be overruled in derived classes. </summary>
	/// <param name="da"> Drawing area. </param>
	/// <param name="comment_string"> Comment string to print. </param>
	...
	/// <summary>
	/// Draws the annotation described in the PropList.  Currently only supported for GRJComponentDrawingAreas. </summary>
	/// <param name="da"> the drawing area on which to draw the annotation. </param>
	/// <param name="p"> the PropList describing the annotation. </param>
	public static void drawAnnotation(GRDrawingArea da, PropList p)
	{
		...
		if (da is GRJComponentDrawingArea)
		{
	...
	/// <summary>
	/// Draw a circular/elliptical arc around a point. </summary>
	/// <param name="da"> Drawing area. </param>
	...
	/// <param name="a1"> Angle at which drawing is to begin (degrees), counter-clockwise from due east. </param>
	/// <param name="a2"> Angle at which drawing is to end (degrees), counter-clockwise from due east. </param>
	...
	/// Draw a circular/elliptical arc around a point. </summary>
	/// <param name="da"> Drawing area. </param>
	/// <param name="arc"> GRArc to draw. </param>
	public static void drawArc(GRDrawingArea da, GRArc arc)
	{
		...
		if (arc.type == GRShape.LOCATOR_ARC)
		{
			...
			// Horizontal line...
			drawLine(da, (arc.pt.x - locator_shape.xcross_width), arc.pt.y, (arc.pt.x + locator_shape.xcross_width), arc.pt.y);
			// Vertical line...
			drawLine(da, arc.pt.x, (arc.pt.y - locator_shape.ycross_height), arc.pt.x, (arc.pt.y + locator_shape.ycross_height));
		}
	...
	/// optionally adding the arrowheads. </summary>
	/// <param name="da"> Drawing area. </param>
	...
	public static void drawArrow(GRDrawingArea da, double x0, double y0, double x1, double y1, GRLineStyleType lineStyle, double[] dashPattern, double dashOffset, GRArrowStyleType fromArrowStyle, GRArrowStyleType toArrowStyle, double arrowWidth, double arrowLength)
	...
	/// <param name="x1"> X coordinates of the second point. </param>
	/// <param name="y1"> Y coordinates of the second point. </param>
	public static void drawArrowSave(GRDrawingArea da, double x0, double y0, double x1, double y1, GRLineStyleType lineStyle, double[] dashPattern, double dashOffset, GRArrowStyleType fromArrowStyle, GRArrowStyleType toArrowStyle, double arrowWidth, double arrowLength)
	{ // Set the dash pattern for the line
		if (lineStyle == GRLineStyleType.SOLID)
		{
			da.setLineDash(null, (double)0.0);
		...
		if (fromArrowStyle == GRArrowStyleType.SOLID)
		{
			...
			double angle1 = angleLine - angleArrowHalf;
			double angle2 = angleLine + angleArrowHalf;
			Message.printStatus(2, "", "From line angle=" + Math.toDegrees(angleLine) + " angle1=" + Math.toDegrees(angle1) + " angle2=" + Math.toDegrees(angle2));
			// Now compute the coordinates, first edge of arrow
			x[1] = x[0] + Math.Cos(angle1) * arrowLength;
			y[1] = y[0] + Math.Sin(angle1) * arrowLength;
			// Second edge of arrow
		...
		if (toArrowStyle == GRArrowStyleType.SOLID)
		{
			...
			double angle1 = angleLine - angleArrowHalf;
			double angle2 = angleLine + angleArrowHalf;
			Message.printStatus(2, "", "To line angle=" + Math.toDegrees(angleLine) + " angle1=" + Math.toDegrees(angle1) + " angle2=" + Math.toDegrees(angle2));
			// Now compute the coordinates, first edge of arrow
			x[1] = x[0] + Math.Cos(angle1) * arrowLength;
			y[1] = y[0] + Math.Sin(angle1) * arrowLength;
			// Second edge of arrow
	...
	/// <summary>
	/// Draw a line from one point to another. </summary>
	/// <param name="da"> Drawing area. </param>
	/// <param name="x0"> X coordinates of the first point. </param>
	/// <param name="y0"> Y coordinates of the first point. </param>
	/// <param name="x1"> X coordinates of the second point. </param>
	...
	/// <summary>
	/// Draw a polygon (last point is connected to first). </summary>
	/// <param name="da"> Drawing area. </param>
	/// <param name="polygon"> GRPolygon to draw. </param>
	...
	/// Draw a polygon (last point is connected to first). </summary>
	/// <param name="da"> Drawing area. </param>
	/// <param name="npts"> Number of points to draw. </param>
	/// <param name="x"> X-coordinates of points. </param>
	/// <param name="y"> Y-coordinates of points. </param>
	...
	/// <summary>
	/// Draw a segmented line </summary>
	/// <param name="da"> the drawing area to draw on </param>
	...
	/// <summary>
	/// Draw a rectangle given a drawing area and rectangle information in data units. </summary>
	/// <param name="da"> GR drawing area. </param>
	/// <param name="xll"> X-coordinates of lower left corner of rectangle. </param>
	/// <param name="yll"> Y-coordinates of lower left corner of rectangle. </param>
	/// <param name="width"> Width of rectangle (can be negative, in which case xll will be recomputed). </param>
	/// <param name="height"> Height of rectangle (can be negative, in which case yll will be recomputed). </param>
	...
	*/
	...
	/// to be optimized, make calls from higher level code.  The shape will not be filled. </summary>
	/// <param name="da"> Drawing area to draw to. </param>
	/// <param name="shape"> GRShape to draw. </param>
	...
	/// <param name="da"> Drawing area to draw to. </param>
	/// <param name="shape"> GRShape to draw. </param>
	/// <param name="fill"> True if the shape should be filled (for shapes that support filling,
	/// like GRPolygon).  The fill is assumed to be solid. </param>
	public static void drawShape(GRDrawingArea da, GRShape shape, bool fill)
	{
	...
	/// Draw a GRShape.  The shape must be one of the core GR shapes (not a derived
	/// shape).  There is a performance hit by calling this method.  If code needs
	/// to be optimized, make calls from higher level code. </summary>
	/// <param name="da"> Drawing area to draw to. </param>
	/// <param name="shape"> GRShape to draw. </param>
	/// <param name="fill"> True if the shape should be filled (for shapes that support filling, like GRPolygon). </param>
	/// <param name="transparency"> Indicates the level of transparency when used with filled shapes.
	/// If 0, the fill is totally opaque (solid).  If 255, the fill is totally
	/// transparent.  This is the reverse of the alpha parameter. </param>
	public static void drawShape(GRDrawingArea da, GRShape shape, bool fill, int transparency)
	{
		if (shape == null)
		{
			return;
	...
	/// <summary>
	/// Draw a symbol at a point.  See the overloaded version for more information. </summary>
	/// <param name="da"> Drawing area. </param>
	/// <param name="symbol"> Symbol to be drawn at point (see GRSymbol.SYM_*). </param>
	/// <param name="x"> X-coordinate of the point in data units. </param>
	/// <param name="y"> Y-coordinate of the point in data units. </param>
	/// <param name="size"> Size of the symbol (see "flag"). </param>
	/// <param name="flag"> Indicates whether data (GRUNIT_DATA) or device (GRUNIT_DEV) units are being used for "size". </param>
	/// <param name="orient"> Orientation for symbol (see flag in GRSymbol, e.g., GRSymbol.SYM_LEFT). </param>
	public static void drawSymbol(GRDrawingArea da, int symbol, double x, double y, double size, int flag, int orient)
	...
	/// <param name="x"> X-coordinate of the point in data units. </param>
	/// <param name="y"> Y-coordinate of the point in data units. </param>
	/// <param name="size_x"> Size of the symbol in the x-direction (see "flag"). </param>
	/// <param name="size_y"> Size of the symbol in the y-direction (see "flag"). </param>
	/// <param name="offset_x"> X offset of the symbol from the given location.  This can be
	/// used to plot multiple symbols at a point. </param>
	/// <param name="offset_y"> Y offset of the symbol from the given location.  This can be
	/// used to plot multiple symbols at a point. </param>
	/// <param name="data"> Array of secondary data.  For example, for scaled symbols like the
	/// teacup this indicates some dynamic data used to draw the symbol.  This is only used for some symbols. </param>
	/// <param name="flag"> Indicates whether data (GRUNIT_DATA) or device (GRUNIT_DEV) units are being used for "size". </param>
	/// <param name="orient"> Orientation for symbol (see flags in GRSymbol, e.g. GRSymbol.SYM_LEFT). </param>
	public static void drawSymbol(GRDrawingArea da, int symbol, double x, double y, double size_x, double size_y, double offset_x, double offset_y, double[] data, int flag, int orient)
	{
	...
	/// <param name="flag"> Indicates whether data (GRUNIT_DATA) or device (GRUNIT_DEV) units are being used for "size". </param>
	/// <param name="orient"> Orientation for symbol (see flags in GRSymbol, e.g. GRSymbol.SYM_LEFT). </param>
	/// <param name="props"> PropList that is only used (currently) when drawing TeaCups.  If
	/// not null, the teacup will be filled to a level specified by the data parameter. </param>
	public static void drawSymbol(GRDrawingArea da, int symbol, double x, double y, double size_x, double size_y, double offset_x, double offset_y, double[] data, int flag, int orient, PropList props)
	{
	...
	/// <param name="props"> PropList that is only used (currently) when drawing TeaCups.  If
	/// not null, the teacup will be filled to a level specified by the data parameter. </param>
	/// <param name="outlineColor"> currently only used by filled triangles, specifies the 
	/// color to draw the outline of the symbol in. </param>
	public static void drawSymbol(GRDrawingArea da, int symbol, double x, double y, double size_x, double size_y, double offset_x, double offset_y, double[] data, int flag, int orient, PropList props, GRColor outlineColor)
	{
		double msizex, msizex2, msizey, msizey2, xs, ys; // Y coordinate scaled to device units
		...
		if (symbol == GRSymbol.SYM_AST)
		{
			...
			__sxm[0] = xs - msizex2 * .707;
			__sym[0] = ys - msizey2 * .707;
			__sxm[1] = xs + msizex2 * .707;
			__sym[1] = ys + msizey2 * .707;
			//if ( flag == GRUnits.DEVICE ) {
	...
	//			da.drawArc ( xs, ys, msizex2, msizey2, 0.0, 360.0 );
		...
		{
			drawSymbol(da, GRSymbol.SYM_DCAR, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_BAR, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
		}
		...
		{
			drawSymbol(da, GRSymbol.SYM_EX, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_CAP, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
		}
		else if (symbol == GRSymbol.SYM_EXDIA)
		{
			drawSymbol(da, GRSymbol.SYM_EXFORDIA, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_DIA, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
		}
		else if (symbol == GRSymbol.SYM_EXDIA1)
		{
			drawSymbol(da, GRSymbol.SYM_EXDIA, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_FDIA1, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
		}
		else if (symbol == GRSymbol.SYM_EXDIA12)
		{
			drawSymbol(da, GRSymbol.SYM_EXDIA, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_FDIA1, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_FDIA2, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
		}
		else if (symbol == GRSymbol.SYM_EXDIA123)
		{
			...
			drawSymbol(da, GRSymbol.SYM_FDIA1, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_FDIA2, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_FDIA3, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
		}
		else if (symbol == GRSymbol.SYM_EXDIA124)
		{
			...
			drawSymbol(da, GRSymbol.SYM_FDIA1, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_FDIA2, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_FDIA4, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
		}
		else if (symbol == GRSymbol.SYM_EXDIA1234)
		{
			drawSymbol(da, GRSymbol.SYM_FDIA, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
		}
		...
		{
			drawSymbol(da, GRSymbol.SYM_EX, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_EDGE, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
		}
		...
		{
			drawSymbol(da, GRSymbol.SYM_FSLASH, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_FSQTRI1, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
		}
		else if (symbol == GRSymbol.SYM_FARR2)
		{
			drawSymbol(da, GRSymbol.SYM_BSLASH, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_FSQTRI2, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
		}
		else if (symbol == GRSymbol.SYM_FARR3)
		{
			drawSymbol(da, GRSymbol.SYM_FSLASH, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_FSQTRI3, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
		}
		else if (symbol == GRSymbol.SYM_FARR4)
		{
			drawSymbol(da, GRSymbol.SYM_BSLASH, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_FSQTRI4, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
		}
	...
	//			fillArc ( da, xs, ys, msizex2, msizey2, 0.0, 360.0, FILL_CHORD );
		...
		{
			drawSymbol(da, GRSymbol.SYM_BOTLINE, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_BAR, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
		}
		else if (symbol == GRSymbol.SYM_LARR)
		{
			drawSymbol(da, GRSymbol.SYM_LCAR, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_MIN, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
		}
		...
		{
			drawSymbol(da, GRSymbol.SYM_PLUS, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_CIR, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
		}
		else if (symbol == GRSymbol.SYM_RARR)
		{
			drawSymbol(da, GRSymbol.SYM_RCAR, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_MIN, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
		}
		...
		{
			drawSymbol(da, GRSymbol.SYM_UCAR, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
			drawSymbol(da, GRSymbol.SYM_BAR, x, y, size_x, size_y, offset_x, offset_y, data, flag, orient);
		}
		...
		else if (symbol == GRSymbol.SYM_PUSHPIN_VERTICAL)
		{
			...
			sym[0] = ys;
			// Left base of point...
			sxm[1] = xs - pinWidth / 2.0;
			sym[1] = ys + ySign * pinLength;
			// Left edge of bottom...
			sxm[2] = sxm[0] - outsideWidth / 2.0;
			sym[2] = sym[1];
			// Top left of bottom rim...
			sxm[3] = sxm[0] - insideWidth / 2.0;
			sym[3] = sym[2] + ySign * bottomRimHeight;
			// Bottom left of top rim...
			sxm[4] = sxm[3];
			sym[4] = sym[3] + ySign * handleLength;
			// Top left of top rim...
			sxm[5] = sxm[2];
			sym[5] = sym[4] + ySign * topRimHeight;
			// Right edge is symmetrical with left...
			sxm[6] = sxm[5] + outsideWidth;
			sym[6] = sym[5];
			sxm[7] = sxm[4] + insideWidth;
			sym[7] = sym[4];
			sxm[8] = sxm[7];
			sym[8] = sym[3];
			sxm[9] = sxm[6];
	...
	/// <summary>
	/// Draw multiple symbols. </summary>
	/// <param name="symbol"> the symbol to draw </param>
	/// <param name="nsymbols"> the number of symbols to draw </param>
	/// <param name="x"> array of x coordinates </param>
	/// <param name="y"> array of y coordinates </param>
	/// <param name="size"> the size of the symbol </param>
	/// <param name="flag"> the symbol flag </param>
	/// <param name="orient"> the symbol orientation </param>
	public static void drawSymbols(GRDrawingArea da, int symbol, int nsymbols, double[] x, double[] y, double size, int flag, int orient)
	{
		if ((x == null) || (y == null))
		{
			return;
	...
	/// adjustment is done in the low-level driver code.  The text color is the same as the symbol color. </summary>
	/// <param name="da"> Drawing area to draw to. </param>
	/// <param name="symbol"> Symbol to draw (see GRSymbol.SYM*). </param>
	/// <param name="x"> Data coordinate for symbol. </param>
	/// <param name="y"> Data coordiante for symbol. </param>
	/// <param name="size"> Size of symbol. </param>
	/// <param name="text"> Text to draw at symbol. </param>
	/// <param name="a"> Angle of text. </param>
	/// <param name="tflag"> Text orientation flags (see GRText). </param>
	/// <param name="flag"> Units of symbol (GRUnits.DEVICE or GRUnits.DATA).  The symbol size
	/// will be scaled appropriately. </param>
	/// <param name="orient"> Symbol orientation (see GRGRSymbol.SYM.*); </param>
	public static void drawSymbolText(GRDrawingArea da, int symbol, double x, double y, double size, string text, double a, int tflag, int flag, int orient)
	{
	...
	/// <summary>
	/// Draw symbol and text, adjusting the text position for the symbol.  The
	/// adjustment is done in the low-level driver code. </summary>
	/// <param name="da"> Drawing area to draw to. </param>
	/// <param name="symbol"> Symbol to draw (see GRSymbol.SYM*).  If less than 0, no
	/// symbol will be drawn (though the text still will be). </param>
	/// <param name="x"> Data coordinate for symbol. </param>
	/// <param name="y"> Data coordiante for symbol. </param>
	/// <param name="size"> Size of symbol. </param>
	/// <param name="text"> Text to draw at symbol.  Can be null (no text will be drawn). </param>
	/// <param name="text_color"> Color to use for text.  The drawing area color change is not persistent. </param>
	/// <param name="a"> Angle of text. </param>
	/// <param name="tflag"> Text orientation flags (see GRText). </param>
	/// <param name="flag"> Units of symbol (GRUnits.DEVICE or GRUnits.DATA).  The symbol size
	/// will be scaled appropriately. </param>
	/// <param name="orient"> Symbol orientation (see GRGRSymbol.SYM.*); </param>
	public static void drawSymbolText(GRDrawingArea da, int symbol, double x, double y, double size, string text, GRColor text_color, double a, int tflag, int flag, int orient)
	{
		double xt = x, yt = y;
	...
	*/
	...
	/// <param name="a"> the angle of rotation, counter-clockwise </param>
	/// <param name="flag"> the text orientation flags (see GRText.*) </param>
	...
	/// or text, each below the last line drawn. </summary>
	/// <param name="da"> the drawing area to draw on </param>
	/// <param name="text"> the text to draw </param>
	/// <param name="x"> the x coordinate </param>
	/// <param name="y"> the y coordinates </param>
	...
	/// <param name="flag"> the text orientation flags (see GRText.*) </param>
	/// <param name="degrees"> the degrees of rotation (this parameter is actually used
	/// in the Swing code, and the rotation is clockwise from east) </param>
	public static void drawText(GRDrawingArea da, string text, double x, double y, double a, int flag, double degrees)
	{
		double xs, ys;
		...
		{
			Message.printDebug(25, "drawText", "At " + x + "," + y + " (" + xs + "," + ys + ") text \"" + text + "\"");
		}
		...
		while (!done)
		{
			...
			index = text.IndexOf(separator, StringComparison.Ordinal);
			if (index == -1)
			{
				done = true;
			}
	...
	/// active color for the drawing area. </summary>
	/// <param name="color"> GRColor to fill the drawing are with. </param>
	...
	/// <summary>
	/// Draw a filled circular/ellpiptical arc around a point. </summary>
	/// <param name="da"> Drawing area. </param>
	/// <param name="x"> X-coordinate of center. </param>
	/// <param name="y"> Y-coordinate of center. </param>
	/// <param name="rx"> Radius in x direction. </param>
	/// <param name="ry"> Radius in y direction. </param>
	/// <param name="a1"> Angle at which drawing is to begin (degrees), counter-clockwise from 3 o'clock.  Thus:<br>
	/// <pre>
	///     90
	/// 180 	  0
	///     270
	/// </pre> </param>
	/// <param name="a2"> Angle at which drawing is to end (degrees), clockwise from 3 o'clock.  Thus:<br>
	/// <pre>
	///     90
	/// 180 	  0
	///     270
	/// </pre> </param>
	/// <param name="fillmode"> Indicates how arc is to be filled. </param>
	public static void fillArc(GRDrawingArea da, double x, double y, double rx, double ry, double a1, double a2, int fillmode)
	{
		double xs = da.scaleXData(x);
		double ys = da.scaleYData(y);
		double rxs = da.scaleXData(rx) - da.scaleXData(0.0);
	...
	/// Draw a filled circular/ellpiptical arc around a point. </summary>
	/// <param name="da"> Drawing area. </param>
	/// <param name="arc"> GRArc to fill. </param>
	/// <param name="fillmode"> Indicates how arc is to be filled. </param>
	...
	/// <param name="da"> Drawing area. </param>
	/// <param name="polygon"> GRPolygon to fill. </param>
	...
	/// <summary>
	/// Fill a polygon with the current color and a degree of transparency. </summary>
	/// <param name="da"> Drawing area. </param>
	/// <param name="polygon"> GRPolygon to fill. </param>
	/// <param name="transparency"> Indicates transparency (255=transparent, 0=opaque). </param>
	...
	/// <summary>
	/// Fill a polygon given a drawing area and polygon information in data units. </summary>
	/// <param name="da"> GR drawing area. </param>
	/// <param name="npts"> Number of points in the polygon. </param>
	/// <param name="x"> X-coordinates of points. </param>
	/// <param name="y"> Y-coordinates of points. </param>
	...
	/// <summary>
	/// Fill a rectangle given a drawing area and rectangle information in data units. </summary>
	/// <param name="da"> GR drawing area. </param>
	/// <param name="xll"> X-coordinates of lower left corner of rectangle. </param>
	/// <param name="yll"> Y-coordinates of lower left corner of rectangle. </param>
	/// <param name="width"> Width of rectangle (can be negative, in which case xll will be recomputed). </param>
	...
	*/
	...
	/// TODO (JTS - 2003-05-05) This parameter isn't even used.  SAM: in the future </param>
	...
	/// Rotation is assumed to be zero. </summary>
	/// <returns> the extents of a string in either data or device units. </returns>
	/// <param name="da"> Drawing area. </param>
	/// <param name="text"> String to determine size. </param>
	/// <param name="flag"> GRUnits.DATA or GRUnits.DEVICE, indicating the units that should be returned for the text size. </param>
	...
	/// Returns the extents of a string in either data or device units.
	/// If the text has the character '\n', it will be treated as line separators and the extents returned
	/// will take into account all the lines of text. </summary>
	/// <returns> the extents of a string in either data or device units. </returns>
	/// <param name="da"> Drawing area. </param>
	/// <param name="text"> String to determine size.
	/// @praam rotation Rotation of the text, were 0 is due east (horizontal), measured clockwise in degrees. </param>
	/// <param name="flag"> GRUnits.DATA or GRUnits.DEVICE, indicating the units that should be returned for the text size. </param>
	...
	/// <summary>
	/// Returns the extents for text drawn in a specific font. </summary>
	/// <param name="da"> the drawing area on which to find the extents. </param>
	/// <param name="text"> the text string for which to find the extents. </param>
	/// <param name="flag"> one of GRUnits.DEVICE or GRUnits.DATA. </param>
	/// <param name="fontname"> the name of the font the text is in. </param>
	/// <param name="style"> the style the text is. </param>
	/// <param name="size"> the size of the text. </param>
	/// <returns> GRLimits describing the extent of the font. </returns>
	public static GRLimits getTextExtents(GRDrawingArea da, string text, int flag, string fontname, string style, int size)
	{ // The following always returns device units...
	...
	/// <summary>
	/// Checks to see if this drawing area's device is drawing antialised. </summary>
	/// <returns> true if the device is drawing anti aliased, false if not. </returns>
	public static bool isDeviceAntiAliased(GRDrawingArea da)
	{
		return da.isDeviceAntiAliased();
	}

	/// <summary>
	/// Draw a line to a point. </summary>
	/// <param name="x"> data X coordinate. </param>
	/// <param name="y"> data Y coordinate </param>
	...
	/// <summary>
	/// Move to a point.  The next lineTo() call will draw from this point. </summary>
	/// <param name="x"> data X coordinate. </param>
	/// <param name="y"> data Y coordinate </param>
	...
	/// TODO (SAM - 2003-05-07) Seems like we might want to have to Device code but leave here for now </summary>
	/// <param name="da"> Drawing area. </param>
	...
	/// <param name="antiAlias"> if true, the device will be told to begin drawing antialiased. </param>
	public static void setDeviceAntiAlias(GRDrawingArea da, bool antiAlias)
	{
		da.setDeviceAntiAlias(antiAlias);
	}

	/// <summary>
	/// Set the type of axis for a drawing area. </summary>
	/// <param name="da"> Drawing area. </param>
	/// <param name="xaxis"> X-axis type (see GRAxis.LINEAR, etc) </param>
	/// <param name="yaxis"> Y-axis type (see GRAxis.LINEAR, etc) </param>
	...
	/// <summary>
	/// Sets the clipping shape.  If null, the clip is removed. </summary>
	...
	/// <summary>
	/// Set color for all drawing. </summary>
	/// <param name="da"> Drawing area. </param>
	...
	/// <summary>
	/// Set the font and its height to be used in drawing area.  A plain style font is used. </summary>
	/// <param name="da"> Drawing area. </param>
	/// <param name="font"> Font name (e.g., "Helvetica"). </param>
	/// <param name="fontht"> Font height, in points (1 inch=72 points). </param>
	...
	/// <summary>
	/// Set the font and its height and style to be used in drawing area. </summary>
	/// <param name="da"> Drawing area. </param>
	/// <param name="font"> Font name (e.g., "Helvetica"). </param>
	/// <param name="style"> Font style ("Plain", "Bold", "Italic"). </param>
	/// <param name="fontht"> Font height, in points (1 inch=72 points). </param>
	...
	/// <summary>
	/// Set the line dash for line-drawing commands. </summary>
	/// <param name="da"> the drawing area on which to set the line dash </param>
	/// <param name="dash"> a double array specifying the dash pattern.  If null, line dashes will be turned off. </param>
	...
	/// <summary>
	/// Sets how lines are joined, for GRJComponentDrawingAreas. </summary>
	...
	/// <summary>
	/// Set the line width to be used in drawing area. </summary>
	/// <param name="da"> the drawing area on which to set the line join style. </param>
	...
	/// <summary>
	/// Set the line width to be used for GRJComponentDrawingAreas. </summary>
	/// <param name="da"> the drawing area on which to set the line join style. </param>
	/// <param name="lineWidth"> the width of the line </param>
