...
namespace RTi.GR
{
	...
	/// </summary>
	public class GRPolylineList : GRShape
	{
	...
	public GRPolylineList(long att_index) : base(att_index)
	{
		type = POLYLINE_LIST;
		total_npts = 0;
		xmin = xmax = 0.0;
	...
	public GRPolylineList(int npolylines_set) : base()
	{
		type = POLYLINE_LIST;
	...
	public GRPolylineList(GRPolylineList polylinelist) : base(polylinelist.index)
	{
		type = POLYLINE_LIST;
	...
	public virtual bool Equals(GRPolylineList polylinelist)
	{
...
//		base.finalize();
	...
	public virtual GRPolyline getPolyline(int i)
	{
	...
	public virtual void setNumPolylines(int npolylines_set)
	{
		...
		{
			Message.printWarning(2, "GRPolylineList.setNumPolylines", "Error allocating memory for " + npolylines_set + " polylines.");
		}
	}
	...
	public virtual void setPolyline(int i, GRPolyline polyline)
	{
		if ((i < 0) || (i > (npolylines - 1)))
		{
			return;
