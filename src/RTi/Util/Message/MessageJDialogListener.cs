...
namespace RTi.Util.Message
{
	...
	/// of actions when a Cancel is acknowledged. </summary>
	/// <param name="command"> Action command that has occurred (currently only "Cancel" is
	/// notified). </param>
	void messageJDialogAction(string command);
