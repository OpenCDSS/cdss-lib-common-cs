...
//ORIGINAL LINE: @SuppressWarnings("serial") public class ReportJDialog extends javax.swing.JDialog implements java.awt.event.ActionListener, javax.swing.event.HyperlinkListener, java.awt.event.WindowListener
	public class ReportJDialog : JDialog, ActionListener, HyperlinkListener, WindowListener
	{
	...
	private IList<string> _info_Vector; // Contains String elements to display in the _info_TextArea object

	private PropList _prop; // PropList object
	private string _help_key; // Help Keyword

	private SimpleJButton _close_JButton, _help_JButton, _print_JButton, _save_JButton, _search_JButton; // Search

	private int _page_length, _print_size; // print point size
	...
	/// <summary>
	/// ReportJDialog constructor. </summary>
	/// <param name="info"> Contains String elements to Display </param>
	...
	/// 
	/// </table> </param>
	public ReportJDialog(JFrame parent, IList<string> info, PropList prop, bool modal) : base(parent, modal)
	{
		_info_Vector = info;
		_prop = prop;
	...
	public ReportJDialog(JDialog parent, IList<string> info, PropList prop, bool modal) : base(parent, modal)
	{
		_info_Vector = info;
		_prop = prop;
...
//		base.finalize();
	...
	private void setGUI()
	{
		...
		if (!string.ReferenceEquals(propValue, null))
		{
			...
			if (Message.isDebugOn)
			{
				Message.printDebug(2, "ReportJDialog.setGUI", "Setting text display area to be of type:\"" + __textComponent + "\"");
			}
		}
