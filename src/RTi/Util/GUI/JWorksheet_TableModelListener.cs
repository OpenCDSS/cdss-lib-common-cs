...
namespace RTi.Util.GUI
{
	...
	/// <summary>
	/// Called when a data value is changed. </summary>
	/// <param name="rowNumber"> the number of the row in which data were changed </param>
	/// <param name="colNumber"> the number of the column in which data were changed </param>
	/// <param name="value"> the new value of the cell corresponding to the row and column
	/// (must be cast appropriately based on the table model). </param>
	void tableModelValueChanged(int rowNumber, int colNumber, object value);
