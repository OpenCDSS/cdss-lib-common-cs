...
namespace RTi.Util.Table
{
	...
	public interface DataTableValueStringProvider
	{
		...
		/// <summary>
		/// Return the object value in a table cell. </summary>
		/// <param name="valueFormat"> a format string to be interpreted by called code,
		/// for example ${Property} when used with TSTool. </param>
		string getTableCellValueAsString(string valueFormat);
	}
