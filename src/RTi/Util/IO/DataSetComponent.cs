...
//ORIGINAL LINE: public void addComponent(DataSetComponent component) throws Exception
	...
	/// <summary>
	/// Get the parent (group) component. </summary>
	/// <returns> the parent (group) component (may be null). </returns>
	public virtual DataSetComponent getParentComponent()
	{
		return __parent;
	}
...
//		base.finalize();
	...
	/// <summary>
	/// Return the file name for the commands used to create the object. </summary>
	/// <returns> the file name for the commands used to create the object. </returns>
	public virtual string getCommandsFileName()
	{
	...
	/// <summary>
	/// Return the data check results, as a list of String. </summary>
	/// <returns> the data check results. </returns>
	public virtual IList<string> getDataCheckResults()
	{
	...
	/// <summary>
	/// Indicate whether the component data had an error reading the input file. </summary>
	/// <returns> true if the component data had an error reading the input file. </returns>
	public virtual bool getErrorReadingInputFile()
	{
		return __errorReadingInputFile;
	}

	/// <summary>
	/// Return the file name for the original list. </summary>
	/// <returns> the file name for the original list. </returns>
	public virtual string getListFileName()
	{
		return __list_file_name;
	}

	/// <summary>
	/// Return the source of the list for the component (see LIST_SOURCE_*). </summary>
	/// <returns> the source of the list for the component. </returns>
	public virtual string getListSource()
	{
...
//ORIGINAL LINE: @SuppressWarnings("rawtypes") java.util.List list = (java.util.List)__data;
	...
	/// that the component is being written to a file or other persistent location. </summary>
	/// <returns> true if the component is being created as output. </returns>
	...
	/// <summary>
	/// Set the commands file name for the component's data. </summary>
	/// <param name="commands_file_name"> Commands file name for the component's data. </param>
	public virtual void setCommandsFileName(string commands_file_name)
	{
		__commandFileName = commands_file_name;
	}

	/// <summary>
	/// Set the component type. </summary>
	/// <param name="type"> Component type. </param>
	public virtual void setComponentType(int type)
	{
		__type = type;
	}
	...
	/// <summary>
	/// Set the data check results, as a list of String. </summary>
	/// <param name="data_check_results"> The data check results. </param>
	public virtual void setDataCheckResults(IList<string> data_check_results)
	{
	...
	public virtual void setDataFileName(string data_file_name)
	{
	...
	public virtual void setDirty(bool is_dirty)
	{
		__is_dirty = is_dirty;
	}
	...
	/// input file. </param>
	public virtual void setErrorReadingInputFile(bool errorReadingInputFile)
	{
		__errorReadingInputFile = errorReadingInputFile;
	}

	/// <summary>
	/// Set whether the component is a group. </summary>
	/// <param name="is_group"> Indicate whether the component is a group collector. </param>
	public virtual void setIsGroup(bool is_group)
	{
		__is_group = is_group;
	}

	/// <summary>
	/// Set whether the component is output. </summary>
	/// <param name="is_output"> Indicate whether the component is being created as output,
	/// which usually means that it is being written to a file or other persistent location. </param>
	public virtual void setIsOutput(bool is_output)
	{
		__is_output = is_output;
	}

	/// <summary>
	/// Set the list file name for the component's data. </summary>
	/// <param name="list_file_name"> List file name for the component's data. </param>
	public virtual void setListFileName(string list_file_name)
	{
	...
	/// <summary>
	/// Set the parent component.  This is used when the parent is a group. </summary>
	/// <param name="parent"> Group component that is the parent. </param>
	public virtual void setParent(DataSetComponent parent)
	{
		__parent = parent;
	}
