...
//ORIGINAL LINE: @SuppressWarnings("serial") public class UnrecognizedRequestException extends Exception
	public class UnrecognizedRequestException : Exception
	{

	public UnrecognizedRequestException(string message) : base(message)
	{
	}
