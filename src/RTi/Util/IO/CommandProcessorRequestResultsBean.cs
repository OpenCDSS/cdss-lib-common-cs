...
namespace RTi.Util.IO
{
	...
	/// <summary>
	/// Return the results data. </summary>
	/// <returns> the results PropList.  The name of the value can be used to
	...
	/// However, the PropList should always be non-null. </returns>
	PropList getResultsPropList();
	...
	/// resolve an issue while returning information. </summary>
	/// <returns> a warning message that explains why the request failed.
	/// The message can include embedded newline characters.
	/// The message can contain newlines. </returns>
	string getWarningText();

	/// <summary>
	/// Return a suggested fix to resolve the warning. </summary>
	/// <returns> a message that offers a suggestion to fix the warning. </returns>
	string getWarningRecommendationText();
