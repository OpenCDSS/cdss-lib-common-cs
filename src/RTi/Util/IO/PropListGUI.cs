...
//ORIGINAL LINE: @SuppressWarnings("serial") public class PropListGUI extends java.awt.Panel implements java.awt.event.ActionListener
	public class PropListGUI : Panel, ActionListener
	{
