...
namespace RTi.Util.IO
{
	...
	{
		/// <summary>
		/// Return a List of objects of the requested class type. </summary>
		/// <returns> a List of objects of the requested class type, or null if no objects of
		/// the requested type are available. </returns>
		/// <param name="c"> Class to return. </param>
		System.Collections.IList getObjectList(Type c);
	}
