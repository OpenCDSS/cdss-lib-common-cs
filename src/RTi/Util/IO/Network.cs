...
namespace RTi.Util.IO
{
	...
	/// </summary>
	public const int POSITION_ABSOLUTE = 1; // go to top or bottom
								// of system
	public const int POSITION_COMPUTATIONAL = 2; // find the next
								// upstream or
								// downstream
								// computation-wise
	public const int POSITION_REACH = 3; // find the most
								// upstream or
								// downstream in a reach
	public const int POSITION_RELATIVE = 4; // find the next
								// upstream or
								// downstream in the
								// same reach - really
								// only applies to going
								// downstream
	public const int POSITION_REACH_NEXT = 5; // Get the next node
								// in the reach.

	public const int POSITION_UPSTREAM = 1; // Flags indicating how
	public const int POSITION_DOWNSTREAM = 2; // to output the
								// network.
	...
	/// </summary>
	protected internal IList<NetworkFeature> _featureList;
	...
	*/
	...
	/// enforced elsewhere. </summary>
	/// <param name="feature"> A network feature to add. </param>
	...
	*/
	...
	/// <summary>
	/// Draw label on plot. </summary>
	/// <param name="da"> GRDrawing area to draw to. </param>
	/// <param name="node"> Node of interest. </param>
	/// <param name="label"> Label for symbol. </param>
	/// <param name="diam"> Diameter for symbol (used for positioning). </param>
	...
	*/
	...
	/// PostScript and screen output. </summary>
	/// <param name="da"> GR drawing area. </param>
	/// <param name="node_top"> Node at the top of the network. </param>
	/// <param name="reach_level_max"> Maximum reach level in data. </param>
	/// <param name="plotflags"> Flags used to control the network format. </param>
	/* REVISIT
	...
	*/
	...
	/// <summary>
	/// Find the downstream node of a certain type. </summary>
	/// <param name="node"> Node to start search. </param>
	/// <param name="type_to_find"> Node type to find. </param>
	...
	*/
	...
	/// needed. </summary>
	/// <returns> HBNode that is found or null if none is found. </returns>
	/// <param name="data_type_to_find"> Types of node data to find.  See NODE_DATA_*
	/// definitions. </param>
	...
	*/
	...
	/// <returns> HBNode that is found or null if not found. </returns>
	...
	*/
	...
	/// <summary>
	/// Return the list of features in the Network. </summary>
	/// <returns> the list of features in the Network. </returns>
	public virtual IList<NetworkFeature> getFeatures()
	{
		return _featureList;
	}
	...
	*/
	...
	/// <returns> a Vector of all identifiers in the network given the types
	...
	/// performance. </returns>
	/// <param name="node_types"> Array of node types to find (see HBNode.NODE_TYPE_*). </param>
	...
	*/
	...
	{
		_featureList = new List<NetworkFeature>();
	}
...
//		base.finalize();
	...
	/// used, for example, to clear the flag before processing the nodes in the network. </summary>
	/// <param name="processed"> Processed flag to set for every feature. </param>
	public virtual void setProcessed(bool processed)
	{
		int size = _featureList.Count;
		NetworkFeature feature = null;
		for (int i = 0; i < size; i++)
		{
			feature = (NetworkFeature)_featureList[i];
