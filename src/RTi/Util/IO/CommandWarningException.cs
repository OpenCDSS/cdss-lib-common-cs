...
//ORIGINAL LINE: @SuppressWarnings("serial") public class CommandWarningException extends Exception
	public class CommandWarningException : Exception
	{

	public CommandWarningException(string message) : base(message)
	{
	}
