...
// RequestParameterInvalidException - an Exception to be thrown when a command processor
// processRequest() required input parameter has invalid data
...
//ORIGINAL LINE: @SuppressWarnings("serial") public class RequestParameterInvalidException extends Exception
	public class RequestParameterInvalidException : Exception
	{
