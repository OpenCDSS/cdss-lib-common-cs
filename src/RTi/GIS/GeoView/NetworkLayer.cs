...
namespace RTi.GIS.GeoView
{
	...
	*/
	using Network = RTi.Util.IO.Network;
	/*
	...
	*/
	...
	/// </summary>
	public class NetworkLayer : GeoLayer
	{

	/// <summary>
	/// Network object for the data layer.
	/// </summary>
	protected internal Network _network = null;

	/// <summary>
	/// Construct a layer from a Network object. </summary>
	/// <param name="network"> Network object to construct layer from. </param>
	/// <exception cref="Exception"> if there is an error reading the file. </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public NetworkLayer(RTi.Util.IO.Network network) throws Exception
	public NetworkLayer(Network network) : base("")
	{
		initialize();
