...
namespace RTi.GIS.GeoView
{
	...
	using BorderJPanel = RTi.Util.GUI.BorderJPanel;
...
//ORIGINAL LINE: @SuppressWarnings("serial") public class GeoViewPropertiesJFrame extends javax.swing.JFrame implements java.awt.event.ActionListener, javax.swing.event.ChangeListener, java.awt.event.WindowListener, java.awt.event.ItemListener
	public class GeoViewPropertiesJFrame : JFrame, ActionListener, ChangeListener, WindowListener, ItemListener
	{
	/// <summary>
	/// Whether the GUI has finished being built or not.  
	/// </summary>
	internal bool __doneInitializing = false;
	/// <summary>
	...
	/// </summary>
	internal bool __geoViewOnly = false;
	...
	/// Button labels.
	/// </summary>
	private string __BUTTON_ADD_LAYOUT = "Add Layout", __BUTTON_DEL_LAYOUT = "Delete Layout";
	...
	/// GeoViewJComponent display, not particular layers. </summary>
	/// <param name="parent"> JFrame from which this object is created. </param>
	/// <param name="geoview"> GeoViewJComponent that is displaying the data. </param>
	/// <param name="gvp"> GeoViewProject containing overall GeoView information. </param>
	/// <param name="parent__geoviewJPanel"> GeoViewJPanel that is used for the display. </param>
	public GeoViewPropertiesJFrame(JFrame parent, GeoViewJComponent geoview, GeoViewProject gvp, GeoViewJPanel parent__geoviewJPanel)
	{
	...
	/// particular layers in a GeoView display. </summary>
	/// <param name="parent"> JFrame from which this object is created. </param>
	/// <param name="layer_view"> GeoLayerView whose properties are being edited. </param>
	/// <param name="geoview"> GeoViewJComponent that is displaying the data. </param>
	/// <param name="gvp"> GeoViewProject containing overall GeoView information. </param>
	/// <param name="parent__geoviewJPanel"> GeoViewPanel that is used for the display. </param>
	public GeoViewPropertiesJFrame(JFrame parent, GeoLayerView layer_view, GeoViewJComponent geoview, GeoViewProject gvp, GeoViewJPanel parent__geoviewJPanel)
	{
		JGUIUtil.setIcon(this, JGUIUtil.getIconImage());
	...
	/// <summary>
	/// This function responds to ActionEvents. </summary>
	...
	*/
		...
		else if (obj == __legendLocationComboBox)
		{
			...
			if (pos.Equals("NorthWest", StringComparison.OrdinalIgnoreCase))
			{
				layout.setPosition(GridBagConstraints.NORTHWEST);
			}
			else if (pos.Equals("NorthEast", StringComparison.OrdinalIgnoreCase))
			{
				layout.setPosition(GridBagConstraints.NORTHEAST);
			}
			else if (pos.Equals("SouthWest", StringComparison.OrdinalIgnoreCase))
			{
				layout.setPosition(GridBagConstraints.SOUTHWEST);
			}
			else if (pos.Equals("SouthEast", StringComparison.OrdinalIgnoreCase))
			{
				layout.setPosition(GridBagConstraints.SOUTHEAST);
			}
			__geoview.redraw(true);
		}
		else if (obj is JCheckBox)
		{
		...
		else if (obj == __labelFieldJComboBox)
		{
			...
			{
				__labelFieldJTextField.setText(__labelFieldJTextField.getText() + "," + __labelFieldJComboBox.getSelectedItem());
			}
		}
	}
	...
	{
		bool dirty = false; // Indicates if anything has changed.
		...
		bool b = __labelSelectedJCheckBox.isSelected();
...
//		base.finalize();
	...
	/// <param name="evt"> ItemEvent object. </param>
	...
	/// the checkbox that was clicked and turns on or off the associated layer in the legend appropriately. </summary>
	/// <param name="cb"> the checkbox that was clicked. </param>
	private void legendCheckBoxChecked(JCheckBox cb)
	{
		bool visible = cb.isSelected();
	...
	private void setupGUI()
	{
		...
		if (__geoViewOnly)
		{
			...
			JGUIUtil.addComponent(geoviewJPanel, label, 0, y, 10, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);

			label = new JLabel("Data Home:");
			JGUIUtil.addComponent(geoviewJPanel, label, 0, ++y, 4, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			...
			JGUIUtil.addComponent(geoviewJPanel, __dataHomeJTextField, 4, y, 6, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);

			label = new JLabel("Projection:");
			JGUIUtil.addComponent(geoviewJPanel, label, 0, ++y, 4, 1, 0, 0, NNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			...
			JGUIUtil.addComponent(geoviewJPanel, __projectionJTextField, 4, y, 6, 1, 0, 0, TNNN, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST);
			...
			JGUIUtil.addComponent(geoviewJPanel, __backgroundColorJTextField, 4, y, 6, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			...
			JGUIUtil.addComponent(geoviewJPanel, __selectColorJTextField, 4, y, 6, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			...
			JGUIUtil.addComponent(geoviewJPanel, __initialExtentJTextField, 4, y, 6, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			...
			JGUIUtil.addComponent(geoviewJPanel, __maximumExtentJTextField, 4, y, 6, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);

			label = new JLabel("Number of Layer Views:");
			JGUIUtil.addComponent(geoviewJPanel, label, 0, ++y, 4, 1, 0, 0, NNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			label = new JLabel("" + __geoview.getNumLayerViews());
			JGUIUtil.addComponent(geoviewJPanel, label, 4, y, 6, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
		}
		...
		if (!__geoViewOnly)
		{
			...
			y = 0;
			JGUIUtil.addComponent(layerJPanel, new JLabel("Properties for the data layer (currently view only):"), 0, y, 10, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);

			JGUIUtil.addComponent(layerJPanel, new JLabel("Name:"), 0, ++y, 4, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			...
			JGUIUtil.addComponent(layerJPanel, __layerView_nameJTextField, 4, y, 6, 1, 0, 0, TNNN, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST);
			...
			{
				JGUIUtil.addComponent(layerJPanel, new JLabel("<html><p style=\"color:red\">Data file (file does not exist):</p></html>"), 0, ++y, 4, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			}
			else
			{
				JGUIUtil.addComponent(layerJPanel, new JLabel("Data file:"), 0, ++y, 4, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			}
			...
			JGUIUtil.addComponent(layerJPanel, __layerFileJTextField, 4, y, 6, 1, 0, 0, TNNN, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST);

			JGUIUtil.addComponent(layerJPanel, new JLabel("Data format:"), 0, ++y, 4, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			...
			JGUIUtil.addComponent(layerJPanel, __layerFormatJTextField, 4, y, 6, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);

			JGUIUtil.addComponent(layerJPanel, new JLabel("Shape type:"), 0, ++y, 4, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			...
			JGUIUtil.addComponent(layerJPanel, __shapeTypeJTextField, 4, y, 6, 1, 0, 0, TNNN, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST);

			JGUIUtil.addComponent(layerJPanel, new JLabel("Number of features:"), 0, ++y, 4, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			propValue = "" + layer.getShapes().Count;
			__numShapesJTextField = new JTextField(propValue, 7);
			__numShapesJTextField.setEditable(false);
			JGUIUtil.addComponent(layerJPanel, __numShapesJTextField, 4, y, 6, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);

			JGUIUtil.addComponent(layerJPanel, new JLabel("Projection:"), 0, ++y, 4, 1, 0, 0, NNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			propValue = "";
			...
			JGUIUtil.addComponent(layerJPanel, __layerProjectionJTextField, 4, y, 6, 1, 0, 0, TNNN, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST);
			...
			y = 0;
			int classification_type = __layerView.getSymbol().getClassificationType();
			JGUIUtil.addComponent(symbol_classJPanel, new JLabel("Classification type:"), 0, y, 1, 1, 0, 0, NNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			...
			JGUIUtil.addComponent(symbol_classJPanel, __singleSymbolJRadioButton, 0, ++y, 1, 1, 0, 0, NNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			...
			JGUIUtil.addComponent(symbol_classJPanel, __uniqueValuesJRadioButton, 0, ++y, 1, 1, 0, 0, NNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			...
			JGUIUtil.addComponent(symbol_classJPanel, __classBreaksJRadioButton, 0, ++y, 1, 1, 0, 0, NNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
				JGUIUtil.addComponent(symbolJPanel, symbol_classJPanel, 0, 0, 3, 1, 0, 0, TLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
			...
			JGUIUtil.addComponent(symbol_classJPanel, __scaledSymbolJRadioButton, 0, ++y, 1, 1, 0, 0, NNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
		...
		*/
			...
			symbol_textJPanel.setLayout(gbl);
				JGUIUtil.addComponent(symbol_textJPanel, new JLabel("Symbols used to draw map features depend on the layer shape"), 0, y, 10, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
				JGUIUtil.addComponent(symbol_textJPanel, new JLabel("type and classification.  A single symbol is the default."), 0, ++y, 10, 1, 0, 0, NLNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
				JGUIUtil.addComponent(symbol_textJPanel, new JLabel("Classification requires that a data attribute be selected."), 0, ++y, 10, 1, 0, 0, NLNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
				JGUIUtil.addComponent(symbolJPanel, symbol_textJPanel, 3, 0, 7, 1, 0, 0, TLBR, GridBagConstraints.NONE, GridBagConstraints.NORTH);
			...
			y = 0;
				JGUIUtil.addComponent(__singleSymbolJPanel,new JLabel("Symbol style:"), 0, y, 1, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			JComboBox _symbol_styleJComboBox = new JComboBox();
			_symbol_styleJComboBox.setEnabled(false);

			if ((shapeType == GeoLayer.POINT) || (shapeType == GeoLayer.POINT_ZM) || (shapeType == GeoLayer.MULTIPOINT))
			{
				...
				Message.printStatus(2,"","Symbol is " + symbol.getStyle() + " " + GRSymbol.ToString(symbol.getStyle()));
			...
			{
				JGUIUtil.addComponent(__singleSymbolJPanel, _symbol_styleJComboBox, 1, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			}

			JGUIUtil.addComponent(__singleSymbolJPanel, new JLabel("Color:"), 0, ++y, 1, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			...
			else
			{
				...
				JGUIUtil.addComponent(__singleSymbolJPanel, _single_colorJTextField, 1, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			if (shapeType == GeoLayer.POLYGON)
			{
				JGUIUtil.addComponent(__singleSymbolJPanel, new JLabel("Outline color:"), 0, ++y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
				...
				{
					_single_outline_colorJTextField.setBackground(symbol.getOutlineColor());
				}
					JGUIUtil.addComponent(__singleSymbolJPanel, _single_outline_colorJTextField, 1, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
				_single_outline_colorJTextField = null;
			}
			if ((shapeType == GeoLayer.POINT) || (shapeType == GeoLayer.POINT_ZM) || (shapeType == GeoLayer.LINE) || (shapeType == GeoLayer.POLYLINE_ZM))
			{
				JGUIUtil.addComponent(__singleSymbolJPanel, new JLabel("Size:"), 0, ++y, 1, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
				...
				_symbol_sizeJTextField.setText(StringUtil.formatString(symbol.getSize(),"%.0f"));
					JGUIUtil.addComponent(__singleSymbolJPanel, _symbol_sizeJTextField, 1, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
				_symbol_sizeJTextField = null;
			}
			y = 0;
				JGUIUtil.addComponent(__singleSymbolJPanel, new JLabel("Single symbol:"), 2, y, 1, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			JPanel single_legend_panel = new GeoLayerViewLegendJPanel(__layerView, false);
			single_legend_panel.setBackground(Color.white);
				JGUIUtil.addComponent(__singleSymbolJPanel, new JScrollPane(single_legend_panel), 2, ++y, 1, 9, 1, 1, TLNN, GridBagConstraints.BOTH, GridBagConstraints.WEST);
			single_legend_panel = null;
				JGUIUtil.addComponent(symbolJPanel, __singleSymbolJPanel, 0, 1, 10, 1, 0, 0, TNNN, GridBagConstraints.HORIZONTAL, GridBagConstraints.SOUTH);
			if (classification_type == GRSymbol.CLASSIFICATION_SINGLE)
			{
				__singleSymbolJPanel.setVisible(true);
			}
			...
			__uniqueValuesJPanel.setLayout(gbl);
				...
				JGUIUtil.addComponent(symbolJPanel, __uniqueValuesJPanel, 3, 1, 7, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			...
			y = 0;
				JGUIUtil.addComponent(__uniqueValuesJPanel, new JLabel("Symbol:"), 0, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
				JGUIUtil.addComponent(__uniqueValuesJPanel, new JLabel("Field:"), 1, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
				JGUIUtil.addComponent(__uniqueValuesJPanel, new GeoLayerViewLegendJPanel(__layerView, false), 0, ++y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			__uniqueValuesFieldJComboBox = new JComboBox();
			__uniqueValuesFieldJComboBox.addItem("Junk");
				JGUIUtil.addComponent(__uniqueValuesJPanel, __uniqueValuesFieldJComboBox, 1, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
				JGUIUtil.addComponent(symbolJPanel, __uniqueValuesJPanel, 0, 1, 10, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			if (classification_type == GRSymbol.CLASSIFICATION_UNIQUE_VALUES)
			{
				__uniqueValuesJPanel.setVisible(true);
			}
			...
			y = 0;
				JGUIUtil.addComponent(__classBreaksJPanel, new JLabel("Classification Field:"), 0, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			...
			__classBreakFieldJComboBox.setSelectedItem(symbol.getClassificationField());
				JGUIUtil.addComponent(__classBreaksJPanel, __classBreakFieldJComboBox, 1, y, 3, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);

				JGUIUtil.addComponent(__classBreaksJPanel, new JLabel("Number of classes:"), 0, ++y, 3, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			...
			JGUIUtil.addComponent(__classBreaksJPanel, _numclassesJTextField, 3, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			...
			int yc = 0;
			JGUIUtil.addComponent(colorJPanel, new JLabel("Symbol color:"), 0, yc, 4, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			...
			JGUIUtil.addComponent(colorJPanel, _color_tableJRadioButton, 0, ++yc, 2, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			...
			JGUIUtil.addToJComboBox(_color_tableJComboBox, GRColorTable.COLOR_TABLE_NAMES);
			if (color_table != null)
			{
				_color_tableJComboBox.setSelectedItem(color_table.getName());
			}
			JGUIUtil.addComponent(colorJPanel, _color_tableJComboBox, 2, yc, 2, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			...
			JGUIUtil.addComponent(colorJPanel, _color_rampJRadioButton, 0, ++yc, 2, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			JGUIUtil.addComponent(colorJPanel, new JLabel("Start:"), 2, yc, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			JTextField _color_ramp1JTextField = new JTextField(5);
			_color_ramp1JTextField.setEnabled(false);
			JGUIUtil.addComponent(colorJPanel, _color_ramp1JTextField, 3, yc, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			JGUIUtil.addComponent(colorJPanel, new JLabel("End:"), 2, ++yc, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			JTextField _color_ramp2JTextField = new JTextField(5);
			_color_ramp2JTextField.setEnabled(false);
			JGUIUtil.addComponent(colorJPanel, _color_ramp2JTextField, 3, yc, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			JRadioButton _custom_colorsJRadioButton = new JRadioButton("Custom Colors", false);
			colors_group.add(_custom_colorsJRadioButton);
			JGUIUtil.addComponent(colorJPanel, _custom_colorsJRadioButton, 0, ++yc, 2, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			_custom_colorsJRadioButton.setEnabled(false);

			JGUIUtil.addComponent(__classBreaksJPanel, colorJPanel, 0, ++y, 4, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			colorJPanel = null;
			...
			if ((shapeType == GeoLayer.POINT) || (shapeType == GeoLayer.POINT_ZM))
			{
				// Later add line.
				int ys = 0;
				JGUIUtil.addComponent(sizeJPanel, new JLabel("Symbol size:"), 0, ys, 2, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
				JGUIUtil.addComponent(sizeJPanel, new JLabel("Start:"), 2, ys, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
				JTextField _size_ramp1JTextField = new JTextField(5);
				_size_ramp1JTextField.setEnabled(false);
				JGUIUtil.addComponent(sizeJPanel, _size_ramp1JTextField, 3, ys, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
				_size_ramp1JTextField = null;
				JGUIUtil.addComponent(sizeJPanel, new JLabel("End:"), 2, ++ys, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
				JTextField _size_ramp2JTextField = new JTextField(5);
				_size_ramp2JTextField.setEnabled(false);
				JGUIUtil.addComponent(sizeJPanel, _size_ramp2JTextField, 3, ys, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
					JGUIUtil.addComponent(__classBreaksJPanel, sizeJPanel, 0, ++y, 4, 1, 1, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			...
			y = 0;
			JGUIUtil.addComponent(__classBreaksJPanel, new JLabel("Class breaks:"), 4, y, 6, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			...
			JGUIUtil.addComponent(__classBreaksJPanel, new JScrollPane(legendJPanel), 4, ++y, 6, 9, 1, 1, TLNN, GridBagConstraints.BOTH, GridBagConstraints.WEST);
			legendJPanel = null;

			// Add the whole class breaks panel...
			JGUIUtil.addComponent(symbolJPanel, __classBreaksJPanel, 0, 1, 10, 1, 1, 1, TNNN, GridBagConstraints.BOTH, GridBagConstraints.SOUTH);
			if (classification_type == GRSymbol.CLASSIFICATION_CLASS_BREAKS)
			{
				__classBreaksJPanel.setVisible(true);
			}
			...
			y = 0;
				JGUIUtil.addComponent(__scaledSymbolJPanel, new JLabel("Symbol style:"), 0, y, 1, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
		...
		*/
			...
			{
					JGUIUtil.addComponent(__scaledSymbolJPanel, __scaledSymbol_styleJComboBox, 1, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			}
			...
			y = 0;
			x = 0;
			   JGUIUtil.addComponent(scaled_symbol_detailJPanel,new JLabel("+Color"), x, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			   JGUIUtil.addComponent(scaled_symbol_detailJPanel,new JLabel("-Color"), ++x, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			JGUIUtil.addComponent(scaled_symbol_detailJPanel, new JLabel("Width"), ++x, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			   JGUIUtil.addComponent(scaled_symbol_detailJPanel,new JLabel("Height"), ++x, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			   JGUIUtil.addComponent(scaled_symbol_detailJPanel,new JLabel("MaxData"), ++x, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			   JGUIUtil.addComponent(scaled_symbol_detailJPanel, new JLabel("MaxDisplay"), ++x, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			...
			for (int isym = 0; isym < nsym; isym++)
			{
				...
				JGUIUtil.addComponent(scaled_symbol_detailJPanel, __scaledSymbol_color1JTextField, x, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
				...
				JGUIUtil.addComponent(scaled_symbol_detailJPanel, __scaledSymbol_color2JTextField, ++x, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
				...
				__scaledSymbol_sizexJTextField.setText(StringUtil.formatString(symbol.getSizeX(),"%.0f"));
					   JGUIUtil.addComponent(scaled_symbol_detailJPanel, __scaledSymbol_sizexJTextField, ++x, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
				...
				__scaledSymbol_sizeyJTextField.setText(StringUtil.formatString(symbol.getSizeY(),"%.0f"));
					   JGUIUtil.addComponent(scaled_symbol_detailJPanel, __scaledSymbol_sizeyJTextField, ++x, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
				...
				__scaledSymbol_maxdataJTextField.setBackground(Color.lightGray);

				if (symbol.getType() == GRSymbol.CLASSIFICATION_SCALED_SYMBOL)
				{
					__scaledSymbol_maxdataJTextField.setText(StringUtil.formatString(((GRScaledClassificationSymbol) symbol).getClassificationDataMax(),"%.2f"));
				}
					   JGUIUtil.addComponent(scaled_symbol_detailJPanel, __scaledSymbol_maxdataJTextField, ++x, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
				...
				if (symbol.getType() == GRSymbol.CLASSIFICATION_SCALED_SYMBOL)
				{
					__scaledSymbol_maxdisplayJTextField.setText(StringUtil.formatString(((GRScaledClassificationSymbol) symbol).getClassificationDataDisplayMax(),"%.2f"));
				}
					   JGUIUtil.addComponent(scaled_symbol_detailJPanel, __scaledSymbol_maxdisplayJTextField, ++x, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
				__scaledSymbol_maxdisplayJTextField = null;

			}

			JGUIUtil.addComponent(__scaledSymbolJPanel, scaled_symbol_detailJPanel, 0, 1, 2, 8, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);

			y = 0;
			JGUIUtil.addComponent(__scaledSymbolJPanel, new JLabel("Scaled Symbol:"), 2, y, 1, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			JPanel scaled_legend_panel = new GeoLayerViewLegendJPanel(__layerView, false);
			scaled_legend_panel.setBackground(Color.white);
			JGUIUtil.addComponent(__scaledSymbolJPanel, new JScrollPane(scaled_legend_panel), 2, ++y, 1, 9, 1, 1, TNNN, GridBagConstraints.BOTH, GridBagConstraints.WEST);
			scaled_legend_panel = null;
				JGUIUtil.addComponent(symbolJPanel, __scaledSymbolJPanel, 0, 1, 10, 1, 0, 0, TNNN, GridBagConstraints.HORIZONTAL, GridBagConstraints.SOUTH);
			...
			y = 0;
			JGUIUtil.addComponent(labelJPanel, new JLabel("Text labels can " + " be formatted from data fields.  Select one or more fields."), 0, y, 7, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			JGUIUtil.addComponent(labelJPanel, new JLabel("Optionally, also use " + " the label format to specify how label fields should be formatted."), 0, ++y, 7, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			JGUIUtil.addComponent(labelJPanel, new JLabel("   Floating point " + "values:  Use %NN.Nf (e.g., %f, %.2f, %10.2f)."), 0, ++y, 7, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
	...
	//		0, ++y, 7, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.WEST );
			JGUIUtil.addComponent(labelJPanel, new JLabel("   Integer values:  " + "Treat as 0-precision float (e.g., %.0f, %f, %10.0f)."), 0, ++y, 7, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			JGUIUtil.addComponent(labelJPanel, new JLabel("   String values:  Use %s (e.g., %s, %20s, %20.20s)."), 0, ++y, 7, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.WEST);

			JGUIUtil.addComponent(labelJPanel, new JLabel("Label field(s):"), 0, ++y, 2, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			...
			JGUIUtil.addComponent(labelJPanel, __labelFieldJComboBox, 2, y, 2, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			propValue = symbol.getLabelField();
			if (string.ReferenceEquals(propValue, null))
			{
			...
			__labelFieldJTextField.setBackground(Color.lightGray);
				JGUIUtil.addComponent(labelJPanel, __labelFieldJTextField, 2, ++y, 2, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			__clearLabelField_JButton = new SimpleJButton("Clear","Clear",this);
				JGUIUtil.addComponent(labelJPanel, __clearLabelField_JButton, 4, y, 1, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.WEST);

			JGUIUtil.addComponent(labelJPanel, new JLabel("Label format:"), 0, ++y, 2, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			...
			JGUIUtil.addComponent(labelJPanel, __labelFormatJTextField, 2, y, 2, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);

			JGUIUtil.addComponent(labelJPanel, new JLabel("Label font:"), 0, ++y, 2, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			JComboBox __labelFontJComboBox = new JComboBox();
			__labelFontJComboBox.setEnabled(false);
			__labelFontJComboBox.addItem("Helvetica");
			JGUIUtil.addComponent(labelJPanel, __labelFontJComboBox, 2, y, 2, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);

			JGUIUtil.addComponent(labelJPanel, new JLabel("Font size (points):"), 0, ++y, 2, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			...
			JGUIUtil.addComponent(labelJPanel, __labelFont_heightJTextField, 2, y, 2, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);

			JGUIUtil.addComponent(labelJPanel, new JLabel("Position:"), 0, ++y, 2, 1, 0, 0, TLNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			...
			_label_positionJComboBox.setSelectedItem(GRText.ToString(symbol.getLabelPosition()));
				JGUIUtil.addComponent(labelJPanel, _label_positionJComboBox, 2, y, 2, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);

			__labelSelectedJCheckBox = new JCheckBox("Label Selected Features Only", symbol.labelSelectedOnly());
				JGUIUtil.addComponent(labelJPanel, __labelSelectedJCheckBox, 0, ++y, 2, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			...
			label = new JLabel("Properties to link data to the application (currently view only):");
				JGUIUtil.addComponent(appJPanel, label, 0, y, 10, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);

			label = new JLabel("Application layer type:");
				JGUIUtil.addComponent(appJPanel, label, 0, ++y, 4, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.EAST);
			...
			JGUIUtil.addComponent(appJPanel, __appLayerTypeJTextField, 4, y, 6, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			...
			__appJoinFieldJTextField.setBackground(Color.lightGray);
				JGUIUtil.addComponent(appJPanel, __appJoinFieldJTextField, 4, y, 6, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
			...
			label = new JLabel("Properties for animation are under development.");
			 JGUIUtil.addComponent(animateJPanel, label, 0, y, 10, 1, 0, 0, TNNN, GridBagConstraints.NONE, GridBagConstraints.WEST);
		}
		else
		{
			//---------------------------------------------------------------------
			...
			JGUIUtil.addComponent(layoutJPanel, new JLabel("Legends are visible on-screen: "), 0, y, 1, 1, 0, 0, TLBN, GridBagConstraints.NONE, GridBagConstraints.NORTHEAST);
			JGUIUtil.addComponent(layoutJPanel, __legendVisibleJCheckBox, 1, y++, 1, 1, 0, 0, TLBN, GridBagConstraints.NONE, GridBagConstraints.NORTHWEST);

			JGUIUtil.addComponent(layoutJPanel, new JLabel("Layout Name: "), 0, y, 1, 1, 0, 0, TLBN, GridBagConstraints.NONE, GridBagConstraints.NORTHEAST);

			IList<string> v = new List<string>();
			v.Add("Default");
			__legendComboBox = new SimpleJComboBox(v, true);
			JGUIUtil.addComponent(layoutJPanel, __legendComboBox, 1, y++, 1, 1, 0, 0, TNBR, GridBagConstraints.NONE, GridBagConstraints.NORTHWEST);
			...
			JGUIUtil.addComponent(layoutJPanel, addLayoutButton, 0, y, 1, 1, 0, 0, TLBR, GridBagConstraints.NONE, GridBagConstraints.CENTER);
			JGUIUtil.addComponent(layoutJPanel, __delLayoutButton, 1, y++, 1, 1, 0, 0, TLBR, GridBagConstraints.NONE, GridBagConstraints.CENTER);

			JGUIUtil.addComponent(layoutJPanel, new JLabel("Location: "), 0, y, 1, 1, 0, 0, TNBR, GridBagConstraints.NONE, GridBagConstraints.NORTHEAST);
			v = new List<string>();
			v.Add("NorthWest");
			v.Add("NorthEast");
			v.Add("SouthWest");
			...
			JGUIUtil.addComponent(layoutJPanel, __legendLocationComboBox, 1, y++, 1, 1, 0, 0, TLBN, GridBagConstraints.NONE, GridBagConstraints.NORTHWEST);
			...
			System.Collections.IList[] vectors = legendJTree.getLayersNamesAndNodes(false);
			System.Collections.IList layers = vectors[0];
			System.Collections.IList names = vectors[1];
			System.Collections.IList nodes = vectors[2];
			...
			for (int i = 0; i < size; i++)
			{
				...
				JGUIUtil.addComponent(panel, checkBox, 0, 0, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
				JGUIUtil.addComponent(panel, nodeLabel, 1, 0, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
				...
				if (num == -1)
				{
					...
					layout.addNodeLayerCheckBox((SimpleJTree_Node)nodes[i], glv, checkBox, checkBox.isSelected());
				}
				else
				{
			...
			JGUIUtil.addComponent(layoutJPanel, new JScrollPane(tree), 0, y++, 10, 1, 1, 0, TLBR, GridBagConstraints.HORIZONTAL, GridBagConstraints.CENTER);
		}
		...
		*/
		...
		if (__geoViewOnly || (string.ReferenceEquals(legend.getText(), null)))
		{
