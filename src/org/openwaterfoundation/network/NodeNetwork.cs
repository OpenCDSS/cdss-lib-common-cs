...
namespace org.openwaterfoundation.network
{
	/// <summary>
	...
	public interface NodeNetwork
	{
		...
		/// <summary>
		/// Return the identifier for the network, typically a short string. </summary>
		/// <returns> network ID </returns>
		string getNetworkId();

		/// <summary>
		/// Return the name for the network, typically a sentence-long description. </summary>
