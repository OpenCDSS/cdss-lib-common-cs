...
namespace riverside.datastore
{
	...
	{
		/// <summary>
		/// Instantiate a DataStore from a PropList of string properties. </summary>
		/// <param name="props"> properties to describe the DataStore configuration. </param>
		DataStore create(PropList props);
	}
