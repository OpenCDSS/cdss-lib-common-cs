...
//ORIGINAL LINE: @SuppressWarnings("serial") public class ERDiagram_Table_TableModel extends RTi.Util.GUI.JWorksheet_AbstractRowTableModel
	public class ERDiagram_Table_TableModel : JWorksheet_AbstractRowTableModel
	{
	...
	/// </summary>
	private readonly int __COL_NAME = 0, __COL_X = 1, __COL_Y = 2;

	/// <summary>
	/// Constructor.  This builds the Model for displaying the given ERDiagram_Table objects' information. </summary>
	/// <param name="data"> list of ERDiagram_Table objects for which to display data. </param>
	/// <exception cref="Exception"> if an invalid data or dmi was passed in. </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public ERDiagram_Table_TableModel(java.util.List data) throws Exception
	public ERDiagram_Table_TableModel(System.Collections.IList data)
	{
		if (data == null)
		{
			throw new Exception("Null data Vector passed to " + "ERDiagram_Table_TableModel constructor.");
		}
	...
	/// inherited from the very base-most java TableModel class and is required. </summary>
	/// <param name="columnIndex"> the column for which to return the data class.
	/// 
	...
	/// object you return in the call to getValueAt(), otherwise an exception will get thrown. </param>
	...
	/// the very base-most Java TableModel class and is required. </summary>
	...
	/// from the very base-most Java TableModel class and is required. </summary>
	...
	/// about this if you ever need to do that. </returns>
	...
	/// required for JWorksheet table models. </summary>
	/// <param name="column"> column for which to return the format. </param>
	/// <returns> the format (as used by StringUtil.formatString() in which to display the column.
	/// 
	/// AML:
	...
	/// correctly up top then the switch() will never be out of bounds ... but it's just a good idea ...  </returns>
	...
	/// column.  This method is inherited from the very base-most Java TableModel class and is required. </summary>
	...
	public virtual object getValueAt(int row, int col)
	{
		...
		switch (col)
		{
			...
			case __COL_X:
				return new double?(table.getX());
			case __COL_Y:
				return new double?(table.getY());
			default:
				return "";
		}
	}
	...
	/// <returns> an integer array containing the widths for each field.
	/// 
	/// AML:
	...
	/// think) and that's the width of the column in pixels </returns>
