...
namespace RTi.GRTS
{
	...
	/// </summary>
	private IList<TSProductAnnotationProvider> __annotationProviders = null;
...
//ORIGINAL LINE: public TSProduct() throws Exception
	...
	/// <summary>
	/// Construct a TSProduct from a product file (.tsp).  The product file is read into a PropList. </summary>
	/// <param name="filename"> Name of gvp file to process. </param>
	/// <param name="overridePropList"> Properties that override the properties in the file. </param>
	/// <exception cref="Exception"> if there is an error processing the file. </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public TSProduct(String filename, RTi.Util.IO.PropList overridePropList) throws Exception
	...
	/// conform to the organization of a time series product file. </summary>
	/// <param name="proplist"> Properties describing the time series product. </param>
	/// <param name="override_proplist"> Properties that override the properties first
	/// PropList (e.g., display properties).  Specify as null if no override properties are given. </param>
	/// <exception cref="Exception"> if there is an error processing the properties. </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public TSProduct(RTi.Util.IO.PropList proplist, RTi.Util.IO.PropList override_proplist) throws Exception
	...
	/// will be set automatically at that point. </summary>
	/// <param name="provider"> the provider to add.  Cannot be null. </param>
	/// <param name="controlProps"> properties that define for each provider how they are to
	/// add annotations.  These properties are provider-specific.  Can be null. </param>
	public virtual void addTSProductAnnotationProvider(TSProductAnnotationProvider provider, PropList controlProps)
	{
		...
		else
		{
			...
			{
				__annotationProviders = new List<TSProductAnnotationProvider>();
				__annotationProviderPropLists = new List<PropList>();
			}
	...
	private void addAnnotations()
	{
		...
		int size = __annotationProviders.Count;
		...
		{
			provider = __annotationProviders[i];
			...
			controlProps = __annotationProviderPropLists[i];
	...
	/// so that duplicate annotations are not set on it. </summary>
	/// <param name="provider"> the provider to check. </param>
	/// <returns> true if the provider was already used to set annotations, false if not. </returns>
	private bool alreadyUsed(TSProductAnnotationProvider provider)
	{
		int size = __usedProviders.Count;
	...
	/// <summary>
	/// Checks annotation properties to make sure that the annotation is fully-defined. </summary>
	/// <param name="isub"> the subproduct of the annotation. </param>
	/// <param name="iann"> the annotation number. </param>
	public virtual void checkAnnotationProperties(int isub, int iann)
	{
		string shapeType = null;

		if (string.ReferenceEquals(getLayeredPropValue("AnnotationID", isub, iann, false, true), null))
		{
			setPropValue("AnnotationID", getDefaultPropValue("AnnotationID", isub, iann, true), isub, iann, true);
		}

		if (string.ReferenceEquals(getLayeredPropValue("AnnotationName", isub, iann, false, true), null))
		{
			setPropValue("AnnotationName", getDefaultPropValue("AnnotationName", isub, iann, true), isub, iann, true);
		}

		if (string.ReferenceEquals(getLayeredPropValue("AnnotationTableID", isub, iann, false, true), null))
		{
			setPropValue("AnnotationTableID", getDefaultPropValue("AnnotationTableID", isub, iann, true), isub, iann, true);
		}

		if (string.ReferenceEquals(getLayeredPropValue("Color", isub, iann, false, true), null))
		{
			setPropValue("Color", getDefaultPropValue("Color", isub, iann, true), isub, iann, true);
		}
		if (string.ReferenceEquals(getLayeredPropValue("Order", isub, iann, false, true), null))
		{
		...
		if (string.ReferenceEquals(getLayeredPropValue("XInputFormat", isub, iann, false, true), null))
		{
			setPropValue("XInputFormat", getDefaultPropValue("XInputFormat", isub, iann, true), isub, iann, true);
		}

		if (string.ReferenceEquals(getLayeredPropValue("XAxisSystem", isub, iann, false, true), null))
		{
			setPropValue("XAxisSystem", getDefaultPropValue("XAxisSystem", isub, iann, true), isub, iann, true);
		}
		if (string.ReferenceEquals(getLayeredPropValue("YAxis", isub, iann, false, true), null))
		{
			setPropValue("YAxis", getDefaultPropValue("YAxis", isub, iann, true), isub, iann, true);
		}
		if (string.ReferenceEquals(getLayeredPropValue("YAxisSystem", isub, iann, false, true), null))
		{
		...
		{
			if (string.ReferenceEquals(getLayeredPropValue("FontSize", isub, iann, false, true), null))
			{
				setPropValue("FontSize", getDefaultPropValue("FontSize", isub, iann, true), isub, iann, true);
			}
			if (string.ReferenceEquals(getLayeredPropValue("FontStyle", isub, iann, false, true), null))
			{
				setPropValue("FontStyle", getDefaultPropValue("FontStyle", isub, iann, true), isub, iann, true);
			}
			if (string.ReferenceEquals(getLayeredPropValue("FontName", isub, iann, false, true), null))
			{
				setPropValue("FontName", getDefaultPropValue("FontName", isub, iann, true), isub, iann, true);
			}
			if (string.ReferenceEquals(getLayeredPropValue("Point", isub, iann, false, true), null))
			{
				setPropValue("Point", getDefaultPropValue("Points", isub, iann, true), isub, iann, true);
			}
			if (string.ReferenceEquals(getLayeredPropValue("Text", isub, iann, false, true), null))
			{
				setPropValue("Text", getDefaultPropValue("Text", isub, iann, true), isub, iann, true);
			}
			if (string.ReferenceEquals(getLayeredPropValue("TextPosition", isub, iann, false, true), null))
			{
				setPropValue("TextPosition", getDefaultPropValue("TextPosition", isub, iann, true), isub, iann, true);
			}
		}
		else if (shapeType.Equals("Line", StringComparison.OrdinalIgnoreCase))
		{
			if (string.ReferenceEquals(getLayeredPropValue("LineStyle", isub, iann, false, true), null))
			{
				setPropValue("LineStyle",getDefaultPropValue("LineStyle",isub, iann, true), isub, iann, true);
			}
			if (string.ReferenceEquals(getLayeredPropValue("LineWidth", isub, iann, false, true), null))
			{
				setPropValue("LineWidth", getDefaultPropValue("LineWidth", isub, iann, true), isub, iann, true);
			}
			if (string.ReferenceEquals(getLayeredPropValue("Points", isub, iann, false, true), null))
			{
		...
		else if (shapeType.Equals("Symbol", StringComparison.OrdinalIgnoreCase))
		{
			...
			if (string.ReferenceEquals(getLayeredPropValue("SymbolPosition", isub, iann, false, true), null))
			{
				setPropValue("SymbolPosition", getDefaultPropValue("SymbolPosition", isub, iann, true), isub, iann, true);
			}

			if (string.ReferenceEquals(getLayeredPropValue("SymbolStyle", isub, iann, false, true), null))
			{
				setPropValue("SymbolStyle", getDefaultPropValue("SymbolStyle", isub, iann, true), isub, iann, true);
			}

			if (string.ReferenceEquals(getLayeredPropValue("SymbolSize", isub, iann, false, true), null))
			{
	...
	/// Data that are not fully-defined will have the property set to a default value. </summary>
	/// <param name="isub"> the subproduct of the annotation. </param>
	/// <param name="iann"> the annotation number. </param>
	public virtual void checkDataProperties(int isub, int its)
	{
	//	Message.printStatus ( 1, "", "Checking TS [" + its+"]");
		...
		if (string.ReferenceEquals(yaxis, null))
		{
		...
		if (string.ReferenceEquals(getLayeredPropValue("Color",isub,its,false), null))
		{
		...
		if (graphType == TSGraphType.POINT)
		{
			...
			if (string.ReferenceEquals(getLayeredPropValue("SymbolStyle",isub,its,false), null))
			{
		...
		if (string.ReferenceEquals(getLayeredPropValue("DataLabelFormat", isub, its, false), null))
		{
		...
		if (string.ReferenceEquals(getLayeredPropValue("DataLabelPosition", isub, its, false), null))
		{
		...
		if (string.ReferenceEquals(getLayeredPropValue("Enabled", isub, its, false), null))
		{
			setPropValue("Enabled", getDefaultPropValue("Enabled",isub,its), isub, its);
		}

		if (string.ReferenceEquals(getLayeredPropValue("FlaggedDataSymbolStyle", isub, its, false), null))
		{
			// Use the SymbolStyle value if specified
			string symbolStyle = getLayeredPropValue("SymbolStyle", isub, its, false);
			if (string.ReferenceEquals(symbolStyle, null))
			{
				setPropValue("FlaggedDataSymbolStyle", getDefaultPropValue("FlaggedDataSymbolStyle", isub,its,false,graphType),isub, its);
			}
			else
			{
		...
		if (string.ReferenceEquals(getLayeredPropValue("GraphType", isub, its, false), null))
		{
			...
			if (!string.ReferenceEquals(tsGraphType, null))
			{
			...
			else
			{
				...
				if (yaxis.Equals("left", StringComparison.OrdinalIgnoreCase))
				{
				...
				if (!string.ReferenceEquals(graphType2, null))
				{
					setPropValue("GraphType", tsGraphType, isub, its);
				}
				else
		...
		if (string.ReferenceEquals(getLayeredPropValue("LegendFormat", isub, its, false), null))
		{
			setPropValue("LegendFormat",getDefaultPropValue("LegendFormat",isub,its), isub, its);
		}

		if (string.ReferenceEquals(getLayeredPropValue("LineStyle", isub, its, false), null))
		{
			setPropValue("LineStyle", getDefaultPropValue("LineStyle",isub, its, false, graphType), isub, its);
		}

		if (string.ReferenceEquals(getLayeredPropValue("LineWidth", isub, its, false), null))
		{
		...
		{
			if (string.ReferenceEquals(getLayeredPropValue("RegressionLineEnabled", isub, its, false), null))
			{
				setPropValue("RegressionLineEnabled", getDefaultPropValue("RegressionLineEnabled", isub,its), isub, its);
			}
			if (string.ReferenceEquals(getLayeredPropValue("XYScatterConfidenceInterval", isub, its, false), null))
			{
				setPropValue("XYScatterConfidenceInterval", getDefaultPropValue("XYScatterConfidenceInterval", isub,its), isub, its);
			}
		}

		if (string.ReferenceEquals(getLayeredPropValue("SymbolSize", isub, its, false), null))
		{
		...
		if (string.ReferenceEquals(getLayeredPropValue("TSAlias", isub, its, false), null))
		{
			setPropValue("TSAlias", getDefaultPropValue("TSAlias",isub,its), isub, its);
		}

		if (string.ReferenceEquals(getLayeredPropValue("TSID", isub, its, false), null))
		{
			setPropValue("TSID", getDefaultPropValue("TSID",isub,its), isub, its);
		}

		if (string.ReferenceEquals(getLayeredPropValue("XAxis", isub, its, false), null))
		{
	...
	public virtual void checkProperties()
	{
		...
		if (string.ReferenceEquals(getLayeredPropValue("CurrentDateTime", -1, -1, false), null))
		{
			setPropValue("CurrentDateTime", getDefaultPropValue("CurrentDateTime",-1,-1), -1, -1);
		}

		if (string.ReferenceEquals(getLayeredPropValue("CurrentDateTimeColor", -1, -1, false), null))
		{
			setPropValue("CurrentDateTimeColor", getDefaultPropValue("CurrentDateTimeColor",-1,-1), -1, -1);
		}

		if (string.ReferenceEquals(getLayeredPropValue("Enabled", -1, -1, false), null))
		{
		...
		if (string.ReferenceEquals(getLayeredPropValue("MainTitleFontName", -1, -1, false), null))
		{
			setPropValue("MainTitleFontName",getDefaultPropValue("MainTitleFontName",-1,-1), -1, -1);
		}
		if (string.ReferenceEquals(getLayeredPropValue("MainTitleFontSize", -1, -1, false), null))
		{
			setPropValue("MainTitleFontSize",getDefaultPropValue("MainTitleFontSize",-1,-1), -1, -1);
		}
		if (string.ReferenceEquals(getLayeredPropValue("MainTitleFontStyle", -1, -1, false), null))
		{
			setPropValue("MainTitleFontStyle",getDefaultPropValue("MainTitleFontStyle",-1,-1), -1,-1);
		}
		if (string.ReferenceEquals(getLayeredPropValue("MainTitleString", -1, -1, false), null))
		{
		...
		if (string.ReferenceEquals(getLayeredPropValue("OutputFile", -1, -1, false), null))
		{
		...
		// ProductID
		if (string.ReferenceEquals(getLayeredPropValue("ProductID", -1, -1, false), null))
		{
			setPropValue("ProductID",getDefaultPropValue("ProductID", -1, -1), -1, -1);
		}

		// ProductName
		if (string.ReferenceEquals(getLayeredPropValue("ProductName", -1, -1, false), null))
		{
		...
		if (string.ReferenceEquals(getLayeredPropValue("ProductType", -1, -1, false), null))
		{
		...
		if (string.ReferenceEquals(getLayeredPropValue("SubTitleFontName", -1, -1, false), null))
		{
			setPropValue("SubTitleFontName",getDefaultPropValue("SubTitleFontName",-1,-1),-1,-1);
		}
		if (string.ReferenceEquals(getLayeredPropValue("SubTitleFontSize", -1, -1, false), null))
		{
			setPropValue("SubTitleFontSize",getDefaultPropValue("SubTitleFontSize",-1,-1),-1,-1);
		}
		if (string.ReferenceEquals(getLayeredPropValue("SubTitleFontStyle", -1, -1, false), null))
		{
			setPropValue("SubTitleFontStyle",getDefaultPropValue("SubTitleFontStyle",-1,-1),-1,-1);
		}
		if (string.ReferenceEquals(getLayeredPropValue("SubTitleString", -1, -1, false), null))
		{
		...
		if (string.ReferenceEquals(getLayeredPropValue("TotalHeight", -1, -1, false), null))
		{
			setPropValue("TotalHeight",getDefaultPropValue("TotalHeight",-1,-1),-1,-1);
		}
		if (string.ReferenceEquals(getLayeredPropValue("TotalWidth", -1, -1, false), null))
		{
		...
		if (string.ReferenceEquals(getLayeredPropValue("LayoutType", -1, -1, false), null))
		{
			setPropValue("LayoutType", getDefaultPropValue("LayoutType",-1, -1), -1, -1);
		}
		if (string.ReferenceEquals(getLayeredPropValue("LayoutNumberOfRows", -1, -1, false), null))
		{
			setPropValue("LayoutNumberOfRows",getDefaultPropValue("LayoutNumberOfRows", -1, -1),-1, -1);
		}
		if (string.ReferenceEquals(getLayeredPropValue("LayoutNumberOfCols", -1, -1, false), null))
		{
		...
		if (string.ReferenceEquals(getLayeredPropValue("ShowDrawingAreaOutline", -1, -1, false), null))
		{
		...
		if (prop_val.Equals("Graph", StringComparison.OrdinalIgnoreCase))
		{
	...
	/// <summary>
	/// Check the graph product type (as opposed to report properties) properties. </summary>
	/// <param name="nsubs"> Number of subproducts. </param>
	public virtual void checkGraphProperties(int nsubs)
	{
		...
		for (int isub = 0; isub < nsubs; isub++)
		{
			...
			if ((graphType == TSGraphType.BAR) && string.ReferenceEquals(getLayeredPropValue("BarOverlap",isub, -1, false), null))
			{
				setPropValue("BarOverlap", getDefaultPropValue("BarOverlap",isub,-1), isub, -1);
			}

			if ((graphType == TSGraphType.BAR) && string.ReferenceEquals(getLayeredPropValue("BarPosition",isub, -1, false), null))
			{
				setPropValue("BarPosition", getDefaultPropValue("BarPosition",isub,-1), isub, -1);
			}

			if (string.ReferenceEquals(getLayeredPropValue("BottomXAxisLabelFontName", isub, -1, false), null))
			{
				setPropValue("BottomXAxisLabelFontName", getDefaultPropValue("BottomXAxisLabelFontName",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("BottomXAxisLabelFontStyle", isub, -1, false), null))
			{
				setPropValue("BottomXAxisLabelFontStyle", getDefaultPropValue("BottomXAxisLabelFontStyle",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("BottomXAxisLabelFontSize", isub, -1, false), null))
			{
				setPropValue("BottomXAxisLabelFontSize", getDefaultPropValue("BottomXAxisLabelFontSize", isub,-1), isub, -1);
			}
			...
			if (string.ReferenceEquals(getLayeredPropValue("BottomXAxisMajorGridColor", isub, -1, false), null))
			{
				...
				{
					setPropValue("BottomXAxisMajorGridColor", getDefaultPropValue("BottomXAxisMajorGridColor", isub,-1), isub, -1);
				}
			}

			// "BottomXAxisMinorGridColor"...

			if (string.ReferenceEquals(getLayeredPropValue("BottomXAxisMinorGridColor", isub, -1, false), null))
			{
				if (graphType == TSGraphType.PERIOD)
				{
					// Don't usually draw the horizontal grid...
				...
				{
					setPropValue("BottomXAxisMinorGridColor", getDefaultPropValue("BottomXAxisMinorGridColor", isub,-1), isub, -1);
				}
			}

			if (string.ReferenceEquals(getLayeredPropValue("BottomXAxisTitleFontName", isub, -1, false), null))
			{
				setPropValue("BottomXAxisTitleFontName", getDefaultPropValue("BottomXAxisTitleFontName",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("BottomXAxisTitleFontStyle", isub, -1, false), null))
			{
				setPropValue("BottomXAxisTitleFontStyle", getDefaultPropValue("BottomXAxisTitleFontStyle", isub,-1),isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("BottomXAxisTitleFontSize", isub, -1, false), null))
			{
				setPropValue("BottomXAxisTitleFontSize", getDefaultPropValue("BottomXAxisTitleFontSize",isub,-1), isub, -1);
			}

			// "DataLabelFontName" property...

			if (string.ReferenceEquals(getLayeredPropValue("DataLabelFontName", isub, -1, false), null))
			{
				setPropValue("DataLabelFontName", getDefaultPropValue("DataLabelFontName",isub,-1),isub, -1);
			}

			// "DataLabelFontSize" property...

			if (string.ReferenceEquals(getLayeredPropValue("DataLabelFontSize", isub, -1, false), null))
			{
				setPropValue("DataLabelFontSize", getDefaultPropValue("DataLabelFontSize",isub,-1),isub, -1);
			}

			// "DataLabelFontStyle" property...

			if (string.ReferenceEquals(getLayeredPropValue("DataLabelFontStyle", isub, -1, false), null))
			{
				setPropValue("DataLabelFontStyle", getDefaultPropValue("DataLabelFontStyle",isub,-1),isub, -1);
			}

			// "DataLabelFormat" property...

			if (string.ReferenceEquals(getLayeredPropValue("DataLabelFormat", isub, -1, false), null))
			{
			...
			if (string.ReferenceEquals(getLayeredPropValue("DataLabelPosition", isub, -1, false), null))
			{
			...
			if (string.ReferenceEquals(getLayeredPropValue("Enabled", isub, -1, false), null))
			{
				setPropValue("Enabled", getDefaultPropValue("Enabled",isub,-1), isub, -1);
			}

			// GraphHeight, GraphWidth calculated

			if (string.ReferenceEquals(getLayeredPropValue("LeftYAxisDirection", isub, -1, false), null))
			{
			...
			if (string.ReferenceEquals(getLayeredPropValue("LeftYAxisLabelFontName", isub, -1, false), null))
			{
				setPropValue("LeftYAxisLabelFontName", getDefaultPropValue("LeftYAxisLabelFontName",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("LeftYAxisLabelFontStyle", isub, -1, false), null))
			{
				setPropValue("LeftYAxisLabelFontStyle", getDefaultPropValue("LeftYAxisLabelFontStyle",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("LeftYAxisLabelFontSize", isub, -1, false), null))
			{
				setPropValue("LeftYAxisLabelFontSize", getDefaultPropValue("LeftYAxisLabelFontSize",isub,-1), isub, -1);
			}

			// "LeftYAxisLabelPrecision" determined at run-time

			if (string.ReferenceEquals(getLayeredPropValue("LeftYAxisLegendPosition", isub, -1, false), null))
			{
			...
			if (string.ReferenceEquals(getLayeredPropValue("LeftYAxisMajorGridColor", isub, -1, false), null))
			{
				if (graphType == TSGraphType.PERIOD)
				{
					// Don't usually draw the horizontal grid...
				...
				{
					setPropValue("LeftYAxisMajorGridColor", getDefaultPropValue("LeftYAxisMajorGridColor", isub,-1), isub, -1);
				}
			}

			if (string.ReferenceEquals(getLayeredPropValue("LeftYAxisMajorTickColor", isub, -1, false), null))
			{
				setPropValue("LeftYAxisMajorTickColor", getDefaultPropValue("LeftYAxisMajorTickColor", isub,-1), isub, -1);
			}

			if (string.ReferenceEquals(getLayeredPropValue("LeftYAxisMax", isub, -1, false), null))
			{
				setPropValue("LeftYAxisMax", getDefaultPropValue("LeftYAxisMax",isub,-1), isub, -1);
			}

			if (string.ReferenceEquals(getLayeredPropValue("LeftYAxisMin", isub, -1, false), null))
			{
			...
			if (string.ReferenceEquals(getLayeredPropValue("LeftYAxisMinorGridColor", isub, -1, false), null))
			{
				if (graphType == TSGraphType.PERIOD)
				{
					// Don't usually draw the horizontal grid...
				...
				{
					setPropValue("LeftYAxisMinorGridColor", getDefaultPropValue("LeftYAxisMinorGridColor", isub,-1), isub, -1);
				}
			}

			if (string.ReferenceEquals(getLayeredPropValue("LeftYAxisTitleFontName", isub, -1, false), null))
			{
				setPropValue("LeftYAxisTitleFontName", getDefaultPropValue("LeftYAxisTitleFontName",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("LeftYAxisTitleFontStyle", isub, -1, false), null))
			{
				setPropValue("LeftYAxisTitleFontStyle", getDefaultPropValue("LeftYAxisTitleFontStyle",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("LeftYAxisTitleFontSize", isub, -1, false), null))
			{
				setPropValue("LeftYAxisTitleFontSize", getDefaultPropValue("LeftYAxisTitleFontSize",isub,-1), isub, -1);
			}
			...
			if (string.ReferenceEquals(getLayeredPropValue("LeftYAxisTitlePosition", isub, -1, false), null))
			{
			...
			if (string.ReferenceEquals(getLayeredPropValue("LeftYAxisTitleRotation", isub, -1, false), null))
			{
			...
			if (string.ReferenceEquals(getLayeredPropValue("LeftYAxisType", isub, -1, false), null))
			{
			...
			if (string.ReferenceEquals(getLayeredPropValue("LegendFontName", isub, -1, false), null))
			{
				setPropValue("LegendFontName", getDefaultPropValue("LegendFontName",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("LegendFontStyle", isub, -1, false), null))
			{
				setPropValue("LegendFontStyle", getDefaultPropValue("LegendFontStyle",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("LegendFontSize", isub, -1, false), null))
			{
				setPropValue("LegendFontSize", getDefaultPropValue("LegendFontSize",isub,-1),isub, -1);
			}

			if (string.ReferenceEquals(getLayeredPropValue("LegendFormat", isub, -1, false), null))
			{
				setPropValue("LegendFormat", getDefaultPropValue("LegendFormat",isub,-1), isub, -1);
			}

			if (string.ReferenceEquals(getLayeredPropValue("LegendPosition", isub, -1, false), null))
			{
				setPropValue("LegendPosition", getDefaultPropValue("LegendPosition",isub,-1),isub, -1);
			}

			if (string.ReferenceEquals(getLayeredPropValue("MainTitleFontName", isub, -1, false), null))
			{
				setPropValue("MainTitleFontName", getDefaultPropValue("MainTitleFontName",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("MainTitleFontStyle", isub, -1, false), null))
			{
				setPropValue("MainTitleFontStyle", getDefaultPropValue("MainTitleFontStyle",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("MainTitleFontSize", isub, -1, false), null))
			{
				setPropValue("MainTitleFontSize", getDefaultPropValue("MainTitleFontSize",isub,-1), isub, -1);
			}

			if (string.ReferenceEquals(getLayeredPropValue("MainTitleString", isub, -1, false), null))
			{
			...
			if (string.ReferenceEquals(getLayeredPropValue("RightYAxisDirection", isub, -1, false), null))
			{
			...
			if (string.ReferenceEquals(getLayeredPropValue("RightYAxisLabelFontName", isub, -1, false), null))
			{
				setPropValue("RightYAxisLabelFontName", getDefaultPropValue("RightYAxisLabelFontName",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("RightYAxisLabelFontStyle", isub, -1, false), null))
			{
				setPropValue("RightYAxisLabelFontStyle", getDefaultPropValue("RightYAxisLabelFontStyle",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("RightYAxisLabelFontSize", isub, -1, false), null))
			{
				setPropValue("RightYAxisLabelFontSize", getDefaultPropValue("RightYAxisLabelFontSize",isub,-1), isub, -1);
			}

			// "RightYAxisLabelPrecision" determined at run-time

			if (string.ReferenceEquals(getLayeredPropValue("RightYAxisLegendPosition", isub, -1, false), null))
			{
			...
			if (string.ReferenceEquals(getLayeredPropValue("RightYAxisMajorGridColor", isub, -1, false), null))
			{
				if (graphType == TSGraphType.PERIOD)
				{
					// Don't usually draw the horizontal grid...
				...
				{
					setPropValue("RightYAxisMajorGridColor", getDefaultPropValue("RightYAxisMajorGridColor", isub,-1), isub, -1);
				}
			}

			if (string.ReferenceEquals(getLayeredPropValue("RightYAxisMajorTickColor", isub, -1, false), null))
			{
				setPropValue("RightYAxisMajorTickColor", getDefaultPropValue("RightYAxisMajorTickColor", isub,-1), isub, -1);
			}

			if (string.ReferenceEquals(getLayeredPropValue("RightYAxisMax", isub, -1, false), null))
			{
				setPropValue("RightYAxisMax", getDefaultPropValue("RightYAxisMax",isub,-1), isub, -1);
			}

			if (string.ReferenceEquals(getLayeredPropValue("RightYAxisMin", isub, -1, false), null))
			{
			...
			if (string.ReferenceEquals(getLayeredPropValue("RightYAxisMinorGridColor", isub, -1, false), null))
			{
				if (graphType == TSGraphType.PERIOD)
				{
					// Don't usually draw the horizontal grid...
				...
				{
					setPropValue("RightYAxisMinorGridColor", getDefaultPropValue("RightYAxisMinorGridColor", isub,-1), isub, -1);
				}
			}

			if (string.ReferenceEquals(getLayeredPropValue("RightYAxisTitleFontName", isub, -1, false), null))
			{
				setPropValue("RightYAxisTitleFontName", getDefaultPropValue("RightYAxisTitleFontName",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("RightYAxisTitleFontStyle", isub, -1, false), null))
			{
				setPropValue("RightYAxisTitleFontStyle", getDefaultPropValue("RightYAxisTitleFontStyle",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("RightYAxisTitleFontSize", isub, -1, false), null))
			{
				setPropValue("RightYAxisTitleFontSize", getDefaultPropValue("RightYAxisTitleFontSize",isub,-1), isub, -1);
			}
			...
			if (string.ReferenceEquals(getLayeredPropValue("RightYAxisTitlePosition", isub, -1, false), null))
			{
			...
			if (string.ReferenceEquals(getLayeredPropValue("RightYAxisTitleRotation", isub, -1, false), null))
			{
			...
			if (string.ReferenceEquals(getLayeredPropValue("RightYAxisType", isub, -1, false), null))
			{
			...
			if (string.ReferenceEquals(getLayeredPropValue("SelectedTimeSeriesLineWidth", isub, -1, false), null))
			{
				setPropValue("SelectedTimeSeriesLineWidth", getDefaultPropValue("SelectedTimeSeriesLineWidth", isub, -1), isub, -1);
			}

			if (string.ReferenceEquals(getLayeredPropValue("SubTitleFontName", isub, -1, false), null))
			{
				setPropValue("SubTitleFontName", getDefaultPropValue("SubTitleFontName",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("SubTitleFontStyle", isub, -1, false), null))
			{
				setPropValue("SubTitleFontStyle", getDefaultPropValue("SubTitleFontStyle",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("SubTitleFontSize", isub, -1, false), null))
			{
				setPropValue("SubTitleFontSize", getDefaultPropValue("SubTitleFontSize",isub,-1), isub, -1);
			}

			if (string.ReferenceEquals(getLayeredPropValue("SubTitleString", isub, -1, false), null))
			{
				setPropValue("SubTitleString", getDefaultPropValue("SubTitleString",isub,-1), isub, -1);
			}

			if (string.ReferenceEquals(getLayeredPropValue("TopXAxisLabelFontStyle", isub, -1, false), null))
			{
				setPropValue("TopXAxisLabelFontStyle", getDefaultPropValue("TopXAxisLabelFontStyle",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("TopXAxisLabelFontSize", isub, -1, false), null))
			{
				setPropValue("TopXAxisLabelFontSize", getDefaultPropValue("TopXAxisLabelFontSize",isub,-1), isub, -1);
			}

			if (string.ReferenceEquals(getLayeredPropValue("TopXAxisTitleFontName", isub, -1, false), null))
			{
				setPropValue("TopXAxisTitleFontName", getDefaultPropValue("TopXAxisTitleFontName",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("TopXAxisTitleFontStyle", isub, -1, false), null))
			{
				setPropValue("TopXAxisTitleFontStyle", getDefaultPropValue("TopXAxisTitleFontStyle",isub,-1), isub, -1);
			}
			if (string.ReferenceEquals(getLayeredPropValue("TopXAxisTitleFontSize", isub, -1, false), null))
			{
				setPropValue("TopXAxisTitleFontSize", getDefaultPropValue("TopXAxisTitleFontSize",isub,-1), isub, -1);
			}

			// TopXAxisTitleString is checked in
			// TSGraphJComponent.checkTSProductGraphs()

			if (string.ReferenceEquals(getLayeredPropValue("TopXAxisLabelFontName", isub, -1, false), null))
			{
				setPropValue("TopXAxisLabelFontName", getDefaultPropValue("TopXAxisLabelFontName",isub,-1), isub, -1);
			}

			// Zoom features...
			if (string.ReferenceEquals(getLayeredPropValue("ZoomEnabled", isub, -1, false), null))
			{
				setPropValue("ZoomEnabled", getDefaultPropValue("ZoomEnabled",isub,-1), isub, -1);
			}
			if ((graphType == TSGraphType.XY_SCATTER) || (graphType == TSGraphType.DURATION) || (graphType == TSGraphType.RASTER))
			{
				// For now disable zooming on these graph types...
				setPropValue("ZoomEnabled", "False", isub, -1);
			}

			if (string.ReferenceEquals(getLayeredPropValue("AnnotationProvider", isub, -1, false), null))
			{
				setPropValue("AnnotationProvider", getDefaultPropValue("AnnotationProvider", isub, -1), isub, -1);
			}

			if (string.ReferenceEquals(getLayeredPropValue("LayoutYPercent", isub, -1, false), null))
			{
			...
			if (graphType == TSGraphType.XY_SCATTER || graphType == TSGraphType.PREDICTED_VALUE || graphType == TSGraphType.PREDICTED_VALUE_RESIDUAL)
			{
				if (string.ReferenceEquals(getLayeredPropValue("XYScatterAnalyzeForFilling", isub, -1, false), null))
				{
					setPropValue("XYScatterAnalyzeForFilling", getDefaultPropValue("XYScatterAnalyzeForFilling",isub,-1), isub, -1);
				}
				if (string.ReferenceEquals(getLayeredPropValue("XYScatterDependentAnalysisPeriodEnd", isub, -1, false), null))
				{
					setPropValue("XYScatterDependentAnalysisPeriodEnd", getDefaultPropValue("XYScatterDependentAnalysisPeriodEnd",isub,-1), isub, -1);
				}
				if (string.ReferenceEquals(getLayeredPropValue("XYScatterDependentAnalysisPeriodStart", isub, -1, false), null))
				{
					setPropValue("XYScatterDependentAnalysisPeriodStart", getDefaultPropValue("XYScatterDependentAnalysisPeriodStart", isub,-1), isub, -1);
				}
				if (string.ReferenceEquals(getLayeredPropValue("XYScatterFillPeriodEnd", isub, -1, false), null))
				{
					setPropValue("XYScatterFillPeriodEnd", getDefaultPropValue("XYScatterFillPeriodEnd", isub,-1), isub, -1);
				}
				if (string.ReferenceEquals(getLayeredPropValue("XYScatterFillPeriodStart", isub, -1, false), null))
				{
					setPropValue("XYScatterFillPeriodStart", getDefaultPropValue("XYScatterFillPeriodStart", isub,-1), isub, -1);
				}
				if (string.ReferenceEquals(getLayeredPropValue("XYScatterIndependentAnalysisPeriodEnd", isub, -1, false), null))
				{
					setPropValue("XYScatterIndependentAnalysisPeriodEnd", getDefaultPropValue("XYScatterIndependentAnalysisPeriodEnd", isub,-1), isub, -1);
				}
				if (string.ReferenceEquals(getLayeredPropValue("XYScatterIndependentAnalysisPeriodStart", isub, -1, false), null))
				{
					setPropValue("XYScatterIndependentAnalysisPeriodStart", getDefaultPropValue("XYScatterIndependentAnalysisPeriodStart", isub,-1), isub, -1);
				}
				if (string.ReferenceEquals(getLayeredPropValue("XYScatterIntercept", isub, -1, false), null))
				{
					setPropValue("XYScatterIntercept", getDefaultPropValue("XYScatterIntercept", isub,-1), isub, -1);
				}
				if (string.ReferenceEquals(getLayeredPropValue("XYScatterMethod", isub, -1, false), null))
				{
					setPropValue("XYScatterMethod", getDefaultPropValue("XYScatterMethod",isub,-1), isub, -1);
				}
				if (string.ReferenceEquals(getLayeredPropValue("XYScatterMonth", isub, -1, false), null))
				{
					setPropValue("XYScatterMonth", getDefaultPropValue("XYScatterMonth",isub,-1), isub, -1);
				}
				if (string.ReferenceEquals(getLayeredPropValue("XYScatterNumberOfEquations", isub, -1, false), null))
				{
					setPropValue("XYScatterNumberOfEquations", getDefaultPropValue("XYScatterNumberOfEquations", isub,-1), isub, -1);
				}
				if (string.ReferenceEquals(getLayeredPropValue("XYScatterTransformation", isub, -1, false), null))
				{
					setPropValue("XYScatterTransformation", getDefaultPropValue("XYScatterTransformation", isub,-1), isub, -1);
				}
			}
	...
	/// "${WorkingDir}/morepath" will be expanded to include the working directory. </summary>
	/// <param name="processor"> the CommandProcessor that has a list of named properties. </param>
	/// <param name="command"> the command that is being processed (may be used later for context sensitive values). </param>
	/// <param name="propertyValue"> the parameter value being expanded. </param>
	public virtual string expandPropertyValue(string propertyValue)
	{
		...
		{
			foundPos = propertyValue.IndexOf(delimStart, searchPos, StringComparison.Ordinal);
			foundPosEnd = propertyValue.IndexOf(delimEnd, (searchPos + delimStart.Length), StringComparison.Ordinal);
			...
			foundProp = propertyValue.Substring((foundPos + 2), foundPosEnd - (foundPos + 2));
			...
			Message.printStatus(2, routine, "Expanded property value is \"" + propertyValue + "\" searchpos is now " + searchPos + " in string \"" + propertyValue + "\"");
		}
		return propertyValue;
	}
...
//		base.finalize();
	...
	/// override proplist) as a sorted List. </summary>
	/// <returns> a sorted list of all the properties in the TSProduct. </returns>
	public virtual IList<Prop> getAllProps()
	{
		IList<Prop> v = new List<Prop>();
	...
	/// may be added to get the defaults from a database, etc. </summary>
	/// <param name="param"> Property to get value for. </param>
	/// <param name="subproduct"> Sub-product number (starting at zero).  A prefix of
	/// "SubProduct X." will be used for the property, where X is (subproduct.
	/// If negative, the sub-product property will not be checked. </param>
	/// <param name="its"> Time series number within a sub-product (starting at zero).  A
	/// prefix of "Data X.Y." will be used for the property, where X is
	/// (subproduct) and Y is (its).  If negative, the data item property will not be checked. </param>
	/// <returns> value of property or null if not found. </returns>
	public virtual string getDefaultPropValue(string param, int subproduct, int its)
	{
	...
	/// not be checked.  This is also used for annotations -- see the isAnnotation property. </param>
	/// <param name="isAnnotation"> is true, then its will be treated as the number of an 
	/// annotation under the given subproduct, rather than a time series under the given subproduct. </param>
	/// <returns> value of property or null if not found. </returns>
	public virtual string getDefaultPropValue(string param, int subproduct, int its, bool isAnnotation)
	{
	...
	/// <param name="isAnnotation"> is true, then its will be treated as the number of an 
	/// annotation under the given subproduct, rather than a time series under the given subproduct. </param>
	/// <param name="graphType"> the kind of graph for which the default prop is being 
	/// returned.  Certain properties have different default values for certain kinds
	/// of graphs.  If null, then the value will be ignored. </param>
	/// <returns> value of property or null if not found. </returns>
	public virtual string getDefaultPropValue(string param, int subproduct, int its, bool isAnnotation, TSGraphType graphType)
	{
		//
		//
		// Annotation properties
		...
		if (isAnnotation)
		{
			if (param.Equals("AnnotationID", StringComparison.OrdinalIgnoreCase))
			{
				return "Annotation " + (its + 1);
			}
			else if (param.Equals("AnnotationTableID", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("Color", StringComparison.OrdinalIgnoreCase))
			{
				return "Black";
			}
			else if (param.Equals("FontName", StringComparison.OrdinalIgnoreCase))
			{
				return "Arial";
			}
			else if (param.Equals("FontSize", StringComparison.OrdinalIgnoreCase))
			{
				return "10";
			}
			else if (param.Equals("FontStyle", StringComparison.OrdinalIgnoreCase))
			{
				return "Plain";
			}
			else if (param.Equals("LineStyle", StringComparison.OrdinalIgnoreCase))
			{
				return "Solid";
			}
			else if (param.Equals("LineWidth", StringComparison.OrdinalIgnoreCase))
			{
				return "1";
			}
			else if (param.Equals("Order", StringComparison.OrdinalIgnoreCase))
			{
				return "OnTopOfData";
			}
			else if (param.Equals("Point", StringComparison.OrdinalIgnoreCase))
			{
				return "0,0";
			}
			else if (param.Equals("Points", StringComparison.OrdinalIgnoreCase))
			{
				return "0,0,1,1,";
			}
			else if (param.Equals("ShapeType", StringComparison.OrdinalIgnoreCase))
			{
				return "Text";
			}
			else if (param.Equals("XInputFormat", StringComparison.OrdinalIgnoreCase))
			{
				return "None";
			}
			...
			else if (param.Equals("TextPosition", StringComparison.OrdinalIgnoreCase))
			{
				return "Right";
			}
			else if (param.Equals("XAxisSystem", StringComparison.OrdinalIgnoreCase))
			{
				return "Data";
			}
			else if (param.Equals("YAxis", StringComparison.OrdinalIgnoreCase))
			{
				return "Left";
			}
			else if (param.Equals("YAxisSystem", StringComparison.OrdinalIgnoreCase))
			{
				return "Data";
			}
			else if (param.Equals("SymbolSize", StringComparison.OrdinalIgnoreCase))
			{
				return "0";
			}
			else if (param.Equals("SymbolStyle", StringComparison.OrdinalIgnoreCase))
			{
				return "None";
			}
			else if (param.Equals("SymbolPosition", StringComparison.OrdinalIgnoreCase))
			{
				return "Center";
			}
			return null;
		...
		{
			// Product property...
			if (param.Equals("CurrentDateTime", StringComparison.OrdinalIgnoreCase))
			{
				return "None";
			}
			else if (param.Equals("CurrentDateTimeColor", StringComparison.OrdinalIgnoreCase))
			{
				return "Green";
			}
			else if (param.Equals("Enabled", StringComparison.OrdinalIgnoreCase))
			{
				return "True";
			}
			else if (param.Equals("LayoutType", StringComparison.OrdinalIgnoreCase))
			{
				return "Grid";
			}
			else if (param.Equals("LayoutNumberOfCols", StringComparison.OrdinalIgnoreCase))
			{
				return "1";
			}
			else if (param.Equals("LayoutNumberOfRows", StringComparison.OrdinalIgnoreCase))
			{
				return "" + getNumSubProducts();
			}
			else if (param.Equals("MainTitleFontName", StringComparison.OrdinalIgnoreCase))
			{
				return "Arial";
			}
			else if (param.Equals("MainTitleFontStyle", StringComparison.OrdinalIgnoreCase))
			{
				return "Plain";
			}
			else if (param.Equals("MainTitleFontSize", StringComparison.OrdinalIgnoreCase))
			{
				return "20";
			}
			else if (param.Equals("MainTitleString", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("OutputFile", StringComparison.OrdinalIgnoreCase))
			{
			...
			else if (param.Equals("PreviewOutput", StringComparison.OrdinalIgnoreCase))
			{
				return "False";
			}
			else if (param.Equals("ProductID", StringComparison.OrdinalIgnoreCase))
			{
				return "Product1";
			}
			else if (param.Equals("ProductName", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("ProductType", StringComparison.OrdinalIgnoreCase))
			{
				return "Graph";
			}
			else if (param.Equals("ShowDrawingAreaOutline", StringComparison.OrdinalIgnoreCase))
			{
				return "False";
			}
			else if (param.Equals("SubTitleFontName", StringComparison.OrdinalIgnoreCase))
			{
				return "Arial";
			}
			else if (param.Equals("SubTitleFontSize", StringComparison.OrdinalIgnoreCase))
			{
				return "10";
			}
			else if (param.Equals("SubTitleFontStyle", StringComparison.OrdinalIgnoreCase))
			{
				return "Plain";
			}
			else if (param.Equals("SubTitleString", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("TotalHeight", StringComparison.OrdinalIgnoreCase))
			{
				//return "400";
				// 2017-04-08 Make larger
				return "600";
			}
			else if (param.Equals("TotalWidth", StringComparison.OrdinalIgnoreCase))
			{
				//return "400";
				// 2017-04-08 Make larger
				return "500";
		...
		{
			// Subproduct property...
			if (param.Equals("BarOverlap", StringComparison.OrdinalIgnoreCase))
			{
				return "False";
			}
			else if (param.Equals("BarPosition", StringComparison.OrdinalIgnoreCase))
			{
				return "CenteredOnDate";
			}
			else if (param.Equals("AnnotationProvider", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("BottomXAxisLabelFontName", StringComparison.OrdinalIgnoreCase))
			{
				return "Arial";
			}
			else if (param.Equals("BottomXAxisLabelFontStyle", StringComparison.OrdinalIgnoreCase))
			{
				return "Plain";
			}
			else if (param.Equals("BottomXAxisLabelFontSize", StringComparison.OrdinalIgnoreCase))
			{
				return "10";
			}
			else if (param.Equals("BottomXAxisMajorGridColor", StringComparison.OrdinalIgnoreCase))
			{
				return "None";
			}
			else if (param.Equals("BottomXAxisMinorGridColor", StringComparison.OrdinalIgnoreCase))
			{
				return "None";
			}
			else if (param.Equals("BottomXAxisTitleFontName", StringComparison.OrdinalIgnoreCase))
			{
				return "Arial";
			}
			else if (param.Equals("BottomXAxisTitleFontStyle", StringComparison.OrdinalIgnoreCase))
			{
				return "Plain";
			}
			else if (param.Equals("BottomXAxisTitleFontSize", StringComparison.OrdinalIgnoreCase))
			{
				return "12";
			}
			else if (param.Equals("BottomXAxisTitleString", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("DataLabelFontName", StringComparison.OrdinalIgnoreCase))
			{
				return "Arial";
			}
			else if (param.Equals("DataLabelFontSize", StringComparison.OrdinalIgnoreCase))
			{
				return "10";
			}
			else if (param.Equals("DataLabelFontStyle", StringComparison.OrdinalIgnoreCase))
			{
				return "Plain";
			}
			else if (param.Equals("DataLabelFormat", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("DataLabelPosition", StringComparison.OrdinalIgnoreCase))
			{
				return "Right";
			}
			else if (param.Equals("Enabled", StringComparison.OrdinalIgnoreCase))
			...
			else if (param.Equals("GraphType", StringComparison.OrdinalIgnoreCase))
			{
				return "Line";
			}
			// "GraphWidth" calculated?
			else if (param.Equals("LayoutYPercent", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("LeftYAxisDirection", StringComparison.OrdinalIgnoreCase))
			{
				return "" + GRAxisDirectionType.NORMAL;
			}
			else if (param.Equals("LeftYAxisIgnoreUnits", StringComparison.OrdinalIgnoreCase))
			{
				return "False";
			}
			else if (param.Equals("LeftYAxisLabelFontName", StringComparison.OrdinalIgnoreCase))
			{
				return "Arial";
			}
			else if (param.Equals("LeftYAxisLabelFontStyle", StringComparison.OrdinalIgnoreCase))
			{
				return "Plain";
			}
			else if (param.Equals("LeftYAxisLabelFontSize", StringComparison.OrdinalIgnoreCase))
			{
				return "10";
			}
			// "LegendPosition" is being replaced by "LeftYAxisLegendPosition"
			else if (param.Equals("LeftYAxisLegendPosition", StringComparison.OrdinalIgnoreCase))
			{
				return "BottomLeft";
			}
			else if (param.Equals("LeftYAxisMajorGridColor", StringComparison.OrdinalIgnoreCase))
			{
				return "lightgray";
			}
			else if (param.Equals("LeftYAxisMajorTickColor", StringComparison.OrdinalIgnoreCase))
			{
				return "None";
			}
			// "LeftYAxisLabelPrecision" determined at run-time
			else if (param.Equals("LeftYAxisMax", StringComparison.OrdinalIgnoreCase))
			{
				return "Auto";
			}
			else if (param.Equals("LeftYAxisMin", StringComparison.OrdinalIgnoreCase))
			{
				return "Auto";
			}
			else if (param.Equals("LeftYAxisMinorGridColor", StringComparison.OrdinalIgnoreCase))
			{
				return "None";
			}
			else if (param.Equals("LeftYAxisTitleFontName", StringComparison.OrdinalIgnoreCase))
			{
				return "Arial";
			}
			else if (param.Equals("LeftYAxisTitleFontStyle", StringComparison.OrdinalIgnoreCase))
			{
				return "Plain";
			}
			else if (param.Equals("LeftYAxisTitleFontSize", StringComparison.OrdinalIgnoreCase))
			{
				return "12";
			}
			else if (param.Equals("LeftYAxisTitlePosition", StringComparison.OrdinalIgnoreCase))
			{
				return "AboveAxis";
			}
			else if (param.Equals("LeftYAxisTitleRotation", StringComparison.OrdinalIgnoreCase))
			{
				return "0";
			}
			else if (param.Equals("LeftYAxisTitleString", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("LeftYAxisType", StringComparison.OrdinalIgnoreCase))
			{
				return "Linear";
			}
			// "LeftYAxisUnits" determined at run-time
			else if (param.Equals("LegendFontName", StringComparison.OrdinalIgnoreCase))
			{
				return "Arial";
			}
			else if (param.Equals("LegendFontStyle", StringComparison.OrdinalIgnoreCase))
			{
				return "Plain";
			}
			else if (param.Equals("LegendFontSize", StringComparison.OrdinalIgnoreCase))
			{
				return "10";
			}
			else if (param.Equals("LegendFormat", StringComparison.OrdinalIgnoreCase))
			{
				return "Auto";
			}
			// "LegendPosition" is being replaced by "LeftYAxisLegendPosition"
			else if (param.Equals("LegendPosition", StringComparison.OrdinalIgnoreCase))
			{
				return "BottomLeft";
			}
			else if (param.Equals("MainTitleFontName", StringComparison.OrdinalIgnoreCase))
			...
			else if (param.Equals("RightYAxisDirection", StringComparison.OrdinalIgnoreCase))
			{
				return "" + GRAxisDirectionType.NORMAL;
			}
			else if (param.Equals("RightYAxisGraphType", StringComparison.OrdinalIgnoreCase))
			{
				return "None";
			}
			else if (param.Equals("RightYAxisIgnoreUnits", StringComparison.OrdinalIgnoreCase))
			{
				return "False";
			}
			else if (param.Equals("RightYAxisLabelFontName", StringComparison.OrdinalIgnoreCase))
			{
				return "Arial";
			}
			else if (param.Equals("RightYAxisLabelFontStyle", StringComparison.OrdinalIgnoreCase))
			{
				return "Plain";
			}
			else if (param.Equals("RightYAxisLabelFontSize", StringComparison.OrdinalIgnoreCase))
			{
				return "10";
			}
			else if (param.Equals("RightYAxisLegendPosition", StringComparison.OrdinalIgnoreCase))
			{
				return "BottomRight";
			}
			else if (param.Equals("RightYAxisMajorGridColor", StringComparison.OrdinalIgnoreCase))
			{
				return "None";
			}
			else if (param.Equals("RightYAxisMajorTickColor", StringComparison.OrdinalIgnoreCase))
			{
				return "None"; // Default for now to be consistent with left, but may change to black
			}
			// "RightYAxisLabelPrecision" determined at run-time
			else if (param.Equals("RightYAxisMax", StringComparison.OrdinalIgnoreCase))
			{
				return "Auto";
			}
			else if (param.Equals("RightYAxisMin", StringComparison.OrdinalIgnoreCase))
			{
				return "Auto";
			}
			else if (param.Equals("RightYAxisMinorGridColor", StringComparison.OrdinalIgnoreCase))
			{
				return "None";
			}
			else if (param.Equals("RightYAxisTitleFontName", StringComparison.OrdinalIgnoreCase))
			{
				return "Arial";
			}
			else if (param.Equals("RightYAxisTitleFontStyle", StringComparison.OrdinalIgnoreCase))
			{
				return "Plain";
			}
			else if (param.Equals("RightYAxisTitleFontSize", StringComparison.OrdinalIgnoreCase))
			{
				return "12";
			}
			else if (param.Equals("RightYAxisTitlePosition", StringComparison.OrdinalIgnoreCase))
			{
				return "None";
			}
			else if (param.Equals("RightYAxisTitleRotation", StringComparison.OrdinalIgnoreCase))
			{
				return "0";
			}
			else if (param.Equals("RightYAxisTitleString", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("RightYAxisType", StringComparison.OrdinalIgnoreCase))
			{
				return "Linear";
			}
			else if (param.Equals("SelectedTimeSeriesLineWidth", StringComparison.OrdinalIgnoreCase))
			{
				return "x2";
			}
			else if (param.Equals("SubTitleFontName", StringComparison.OrdinalIgnoreCase))
			...
			else if (param.Equals("TopXAxisLabelFontName", StringComparison.OrdinalIgnoreCase))
			{
				return "Arial";
			}
			else if (param.Equals("TopXAxisLabelFontStyle", StringComparison.OrdinalIgnoreCase))
			{
				return "Plain";
			}
			else if (param.Equals("TopXAxisLabelFontSize", StringComparison.OrdinalIgnoreCase))
			{
				return "10";
			}
			else if (param.Equals("TopXAxisTitleFontName", StringComparison.OrdinalIgnoreCase))
			{
				return "Arial";
			}
			else if (param.Equals("TopXAxisTitleFontStyle", StringComparison.OrdinalIgnoreCase))
			{
				return "Plain";
			}
			else if (param.Equals("TopXAxisTitleFontSize", StringComparison.OrdinalIgnoreCase))
			{
				return "12";
			}
			else if (param.Equals("TopXAxisTitleString", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("XYScatterAnalyzeForFilling", StringComparison.OrdinalIgnoreCase))
			{
				return "false";
			}
			else if (param.Equals("XYScatterDependentAnalysisPeriodEnd", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("XYScatterDependentAnalysisPeriodStart", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("XYScatterFillPeriodEnd", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("XYScatterFillPeriodStart", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("XYScatterIndependentAnalysisPeriodEnd", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("XYScatterIndependentAnalysisPeriodStart", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("XYScatterIntercept", StringComparison.OrdinalIgnoreCase))
			{
				return ""; // No intercept - calculate it
			}
			else if (param.Equals("XYScatterMethod", StringComparison.OrdinalIgnoreCase))
			{
				return "OLSRegression";
			}
			else if (param.Equals("XYScatterMonth", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("XYScatterNumberOfEquations", StringComparison.OrdinalIgnoreCase))
			{
				return "OneEquation";
			}
			else if (param.Equals("XYScatterTransformation", StringComparison.OrdinalIgnoreCase))
			{
				return "None";
			}
			else if (param.Equals("ZoomEnabled", StringComparison.OrdinalIgnoreCase))
			{
				return "True";
			}
			else if (param.Equals("ZoomGroup", StringComparison.OrdinalIgnoreCase))
			{
				return "1";
			}
		}
		...
		{
			// Data property...
			if (param.Equals("Color", StringComparison.OrdinalIgnoreCase))
			{
				return "black";
			}
			else if (param.Equals("DataLabelFormat", StringComparison.OrdinalIgnoreCase))
			...
			else if (param.Equals("FlaggedDataSymbolStyle", StringComparison.OrdinalIgnoreCase))
			{
				// Same as "SymbolStyle"
			...
			else if (param.Equals("RegressionLineEnabled", StringComparison.OrdinalIgnoreCase))
			{
				return "true";
			}
			else if (param.Equals("SymbolSize", StringComparison.OrdinalIgnoreCase))
			...
			else if (param.Equals("TSAlias", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("TSID", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("XAxis", StringComparison.OrdinalIgnoreCase))
			{
				return "Bottom";
			}
			else if (param.Equals("XYScatterConfidenceInterval", StringComparison.OrdinalIgnoreCase))
			{
				return "";
			}
			else if (param.Equals("YAxis", StringComparison.OrdinalIgnoreCase))
	...
	/// always be override if an override property is specified. </summary>
	...
	/// dynamically add annotations without conflict. </returns>
	public virtual string getLayeredPropValue(string property, int subproduct, int its)
	{
	...
	/// searched in layered fashion, starting with the product, then the sub-product,
	/// and then the time series.  The last value specified will be used (but will
	/// always be overridden if an override property is specified). </summary>
	/// <param name="subproduct"> Sub-product number (starting at zero).  A prefix of
	/// "SubProduct X." will be used for the property, where X is (subproduct.
	/// If negative, the sub-product property will not be checked. </param>
	/// <param name="its"> Time series number within a sub-product (starting at zero).  A
	...
	/// (subproduct) and Y is (its).  If negative, the data item property will not be checked. </param>
	/// <param name="property"> Property to get value for. </param>
	/// <param name="allowLayeredProps"> If true, properties are allowed to be layered, with
	...
	/// layering).  An example of a property that may occur in several layers is "Enabled". </param>
	/// <returns> value of property or null if not found. </returns>
	public virtual string getLayeredPropValue(string property, int subproduct, int its, bool allowLayeredProps)
	{
	...
	/// isAnnotation parameter for more info. </param>
	/// <param name="property"> Property to get value for. </param>
	/// <param name="allowLayeredProps"> If true, properties are allowed to be layered, with
	...
	/// layering).  An example of a property that may occur in several layers is "Enabled". </param>
	/// <param name="isAnnotation"> if true, then its will be treated as the number of an
	/// annotation under the given subproduct, rather than the number of a time series
	/// under the given subproduct. </param>
	/// <returns> value of property or null if not found. </returns>
	public virtual string getLayeredPropValue(string property, int subproduct, int its, bool allowLayeredProps, bool isAnnotation)
	{
		string value = null;
		string value2 = null;
		...
		if (allowLayeredProps)
		{
			...
			if (__proplist != null)
			{
				...
				if (!string.ReferenceEquals(value2, null))
				{
					value = value2;
				}
				...
				// TODO SAM Math.abs() doesn't make sense, but it's been like that for years now.
					if (isAnnotation)
					{
						value2 = __proplist.getValue("Annotation " + (Math.Abs(subproduct) + 1) + "." + (its + 1) + "." + property);
					}
					else
					{
		...
		else
		{
			...
			else if ((subproduct >= 0) && (its >= 0))
			{
				...
				if (isAnnotation)
				{
					return __proplist.getValue("Annotation " + (subproduct + 1) + "." + (its + 1) + "." + property);
				}
				else
				{
					return __proplist.getValue("Data " + (subproduct + 1) + "." + (its + 1) + "." + property);
				}
			}
		}
	...
	/// from 0 that return a valid value. </summary>
	/// <param name="subproduct"> the subproduct to check for annotations. </param>
	/// <returns> the number of annotations for the given subproduct. </returns>
	public virtual int getNumAnnotations(int subproduct)
	{
		int ndata = -1;
	...
	/// The largest N that returns a value is assumed to be the number of data sets. </summary>
	/// <param name="subproduct"> The subproduct to check (zero or greater). </param>
	/// <returns> the number of data sets for a subproduct or zero if none are defined. </returns>
	public virtual int getNumData(int subproduct)
	{
		int ndata = -1;
		string prop_value = null;
		for (int i = 0; ; i++)
	...
	/// <summary>
	/// Return the total number of subproducts (enabled and disabled) that are defined for the product. </summary>
	/// <returns> the number of subproducts or zero if none are defined. </returns>
	public virtual int getNumSubProducts()
	{
	...
	/// that returns a value is assumed to be the number of subproducts. </summary>
	/// <returns> the number of subproducts or zero if none are defined. </returns>
	/// <param name="enabled_only"> If true, only enabled subproducts are counted. </param>
	public virtual int getNumSubProducts(bool enabled_only)
	{
		int nsubs = -1;
		string prop_value = null;
	...
	/// </summary>
	public virtual int getNumZoomGroups()
	{
		return __num_zoom_groups;
	}

	/// <summary>
	/// Return the override PropList for the TSProduct. </summary>
	/// <returns> the override PropList for the TSProduct. </returns>
	public virtual PropList getOverridePropList()
	{
		return __override_proplist;
	}

	/// <summary>
	/// Return the property value for an override property. </summary>
	/// <param name="property"> Property to get value for. </param>
	/// <returns> value of property or null if not found. </returns>
	public virtual string getOverridePropValue(string property)
	{
		if (__override_proplist != null)
		{
	...
	/// <summary>
	/// Return the PropList for the TSProduct. </summary>
	/// <returns> the PropList for the TSProduct. </returns>
	...
	/// <summary>
	/// Returns how the properties are being set. </summary>
	/// <returns> how the properties are being set. </returns>
	public virtual int getPropsHowSet()
	{
	...
	/// name is used.  Use getLayeredPropValue() to request a property using product, subproduct, etc. </summary>
	/// <param name="property"> Property to get value for. </param>
	/// <returns> value of property or null if not found. </returns>
	public virtual string getPropValue(string property)
	{
		string value = null;
		if (__override_proplist != null)
		{
	...
	/// <summary>
	/// Return the time series at the requested position. </summary>
	/// <param name="pos"> index position (0+) within time series list. </param>
	/// <returns> the time series at the requested position, or null if not available. </returns>
	public virtual TS getTS(int pos)
	{
		if (__tslist == null)
		{
			return null;
		}
		if (pos >= __tslist.Count)
		{
			return null;
		}
		return __tslist[pos];
	...
	/// <summary>
	/// Return the list of time series associated with the TSProduct. </summary>
	/// <returns> the list of time series associated with the TSProduct. </returns>
	...
	/// <summary>
	/// Returns true if the product has any time series in the internal ts list, false otherwise. </summary>
	/// <returns> true if the product has any time series in the internal ts list, false otherwise. </returns>
	public virtual bool hasTimeSeries()
	{
	...
	/// (properties set with SET_AT_RUNTIME_BY_USER). </summary>
	/// <returns> true if anything has been changed in the TSProduct. </returns>
	...
	/// </summary>
	protected internal virtual void propsSaved()
	{
		Prop p = null;
		int size = __proplist.size();
		for (int i = 0; i < size; i++)
	...
	/// consecutive (excluding the one to be deleted). </summary>
	/// <param name="sp"> the number of the subproduct (0-based) in which the annotation is found. </param>
	/// <param name="iann"> the number of the annotation (0-based) to remove. </param>
	protected internal virtual void removeAnnotation(int sp, int iann)
	{
	...
	//Message.printStatus(1, "", "Size: " + __proplist.size());
		for (int i = 0; i < __proplist.size(); i++)
		{
			...
			{
				indexSpace = key.IndexOf(" ", StringComparison.Ordinal);
				indexDot1 = key.IndexOf(".", StringComparison.Ordinal);
				if (indexSpace > -1 && indexDot1 > -1)
				{
					num1 = key.Substring(indexSpace + 1, indexDot1 - (indexSpace + 1));
					rest = key.Substring(indexDot1 + 1);
					indexDot2 = rest.IndexOf(".", StringComparison.Ordinal);
	...
	/// the layout component already, which calls this method. </summary>
	/// <param name="sp"> the number of the subproduct (0-based) to remove. </param>
	protected internal virtual void removeSubProduct(int sp)
	{
		Prop p = null;
		string key = "";
		int indexSpace = -1;
		...
		for (int i = 0; i < numData; i++)
		{
			...
			for (int j = 0; j < __tslist.Count; j++)
			{
				ts = (TS)__tslist[j];
		...
		for (int i = 0; i < __proplist.size(); i++)
		{
			...
			key = p.getKey();
			indexSpace = key.IndexOf(" ", StringComparison.Ordinal);
			indexDot = key.IndexOf(".", StringComparison.Ordinal);
			if (indexSpace > -1 && indexDot > -1)
			{
				num = key.Substring(indexSpace + 1, indexDot - (indexSpace + 1));
				if (num.Equals(del))
				{
					__proplist.unSet(key);
					i--;
	...
	/// used to maintain proper ordered numbering schemes in the proplist when deleting annotations. </summary>
	/// <param name="origSub"> the original subproduct number of the annotation properties </param>
	/// <param name="origAnn"> the original annotation number of the properties </param>
	/// <param name="newSub"> the new subproduct number of the annotation properties </param>
	/// <param name="newAnn"> the new annotation number of the properties </param>
	protected internal virtual void renameAnnotationProps(string origSub, string origAnn, string newSub, string newAnn)
	{
		Prop p = null;
		string key = "";
		int indexSpace = -1;
			...
			if (StringUtil.startsWithIgnoreCase(key, "Annotation "))
			{
				...
				if (indexSpace > -1 && indexDot1 > -1)
				{
					...
					if (num1.Equals(origSub) && indexDot2 > -1 && num2.Equals(origAnn))
					{
						...
						__proplist.unSet(key);
						i--;
						p.setKey(key.Substring(0, indexSpace) + " " + newSub + "." + newAnn + rest.Substring(indexDot2));
						v.Add(p);
					}
				}
			}
	...
	/// respectively.  For this reason, the parameters are not 0-based.  This is 
	/// used to maintain proper ordered numbering schemes in the proplist when deleting data properties. </summary>
	/// <param name="origSub"> the original subproduct number of the data properties </param>
	/// <param name="origD"> the original data number of the properties </param>
	/// <param name="newSub"> the destination subproduct number of the data properties </param>
	/// <param name="newData"> the destination data number of the properties </param>
	protected internal virtual void renameDataProps(string origSub, string origD, string newSub, string newData)
	{
		Prop p = null;
		string key = "";
		int indexSpace = -1;
	...
	/// used to maintain proper ordered numbering schemes in the proplist when deleting subproduct properties. </summary>
	/// <param name="origSub"> the original number of the properties </param>
	/// <param name="destSub"> the destination number of the properties </param>
	...
	/// This is used when subproducts are moved, removed, or added to the product. </summary>
	/// <param name="dirty"> whether the TSProduct has been changed in a major way that's not
	/// detectable at a prop level (true) or not. </param>
	...
	/// in the reference graph but the TSProduct itself will be used for both the full and reference graphs. </summary>
	/// <param name="property"> Override property to set. </param>
	/// <param name="value"> Value of override property. </param>
	public virtual void setOverridePropValue(string property, string value)
	{
		if (__override_proplist == null)
		{
			// Create a new list...
	...
	/// <summary>
	/// For every property in the TSProduct, changes its setHowSet value to the specified value. </summary>
	/// <param name="how"> the value to set every Prop's setHowSet value to.
	/// TODO (2005-11-01) change name to 'changeAllPropsHowSet'
	/// @deprecated </param>
	public virtual void setPropsHowSet(int how)
	{
		int size = __proplist.size();
		for (int i = 0; i < size; i++)
		{
	...
	/// <summary>
	/// Specifies the HOW_SET for new properties that are set in the product. </summary>
	/// <param name="how"> the value to set new Prop's setHowSet value to.
	/// TODO (JTS - 2005-11-01) once the other method with the same name is corrected, remove the dummy
	/// parameter in this method. </param>
	public virtual void setPropsHowSet(int how, bool dummy)
	{
	...
	/// property is set in the main PropList (not the override PropList). </summary>
	/// <param name="property"> Property to set.  Use only the property name (e.g., "MyProp").
	/// The leading property, sub-property, or data prefixes will be added based on the other parameter values. </param>
	/// <param name="value"> String value of the property. </param>
	/// <param name="subproduct"> Sub-product number (starting at zero).  A prefix of
	/// "SubProduct X." will be used for the property, where X is (subproduct.
	/// If negative, the sub-product property will not be checked (indicating a full product property). </param>
	/// <param name="its"> Time series number within a sub-product (starting at zero).  A
	/// prefix of "Data X.Y." will be used for the property, where X is
	/// (subproduct) and Y is (its).  If negative, the data item property will
	/// not be checked (indicating a sub-product or product property). </param>
	public virtual void setPropValue(string property, string value, int subproduct, int its)
	{
	...
	/// "SubProduct X." will be used for the property, where X is (subproduct.
	/// If negative, the sub-product property will not be checked (indicating a full product property). </param>
	/// <param name="its"> Time series or annotation number within a sub-product (starting at 
	...
	/// See isAnnotation for more information. </param>
	/// <param name="isAnnotation"> is true, then its is treated as the number of an annotation
	/// under the given subproduct, rather than the number of a time series under the given subproduct. </param>
	public virtual void setPropValue(string property, string value, int subproduct, int its, bool isAnnotation)
	{
		if (isAnnotation)
		{
			if (subproduct < 0 || its < 0)
			{
				Message.printWarning(2, "setPropValue", "Negative value" + " in call to setPropValue for annotation property.  uniquetempvar.  Nothing will be set.");
				return;
			}
	...
	/// the annotations from those providers will be set on the graph at this point. </summary>
	/// <param name="tslist"> list of TS associated with the TSProduct. </param>
	public virtual void setTSList(IList<TS> tslist)
	{
		__tslist = tslist;
	...
	/// This is only used for troubleshooting. </summary>
	/// <param name="statusLevel"> the status level at which to print the properties. </param>
	public virtual void showProps(int statusLevel)
	{
		int size = __proplist.size();
	...
	/// This is only used for troubleshooting. </summary>
	/// <param name="statusLevel"> the status level at which to print the properties. </param>
	public virtual void showPropsStartingWith(int statusLevel, string start)
	{
		Prop p = null;
		Message.printStatus(statusLevel, "", "--------------------------------------");
		int size = __proplist.size();
	...
	/// </summary>
	protected internal virtual void sortProps()
	{
		__proplist.sortList();
		if (__override_proplist == null)
		{
	...
	/// </summary>
	public virtual void startAddingHiddenProps()
	{
	...
	/// </summary>
	public virtual void stopAddingHiddenProps()
	{
	...
	/// that were numbered 1.1 will now be numbered 3.2 and vice versa. </summary>
	/// <param name="origSub"> the original subproduct (base 0) </param>
	/// <param name="origAnn"> the original annotation (base 0) </param>
	/// <param name="newSub"> the destination subproduct (base 0) </param>
	/// <param name="newAnn"> the destination annotation (base 0) </param>
	protected internal virtual void swapAnnotations(int origSub, int origAnn, int newSub, int newAnn)
	{
	...
	/// </summary>
	protected internal virtual void swapSubProducts(int origSub, int newSub)
	{
	...
	/// <summary>
	/// Output the product to a text representation. </summary>
	/// <param name="outputAll"> indicates whether to output all the properties (true),
	/// or only those that are different from defaults (false).
	/// The latter is generally the legacy behavior used by software to create shorter files. </param>
	/// <param name="outputHowSet"> indicate whether "how set" value should be output in addition to property value,
	/// typically only when debugging. </param>
	/// <param name="formatType"> the format used in output. </param>
	/// <param name="sort"> indicate whether properties should be sorted (true) or left in default order (false). </param>
	/// <returns> the product formatted as a string using the specified format type. </returns>
	public virtual string ToString(bool outputAll, bool outputHowSet, TSProductFormatType formatType, bool sort)
	{
		...
		IList<Prop> props = __proplist.getPropsMatchingRegExp("Product.*");
		Prop prop = null;
		int howSet = 0;
		...
		*/
		...
		for (int i = 0; i < size; i++)
		{
			...
			{
				if ((howSet == Prop.SET_FROM_PERSISTENT) || (howSet == Prop.SET_AT_RUNTIME_BY_USER) || (howSet == Prop.SET_AT_RUNTIME_FOR_USER))
				{
					output = true;
				}
			}
			...
			for (int i = 0; i < size; i++)
			{
				...
				else if (!outputAll)
				{
					...
					if (!outputHowSet)
					{
						...
						if (key.ToUpper().EndsWith("PRODUCTIDORIGINAL", StringComparison.Ordinal))
						{
							continue;
						}
						else if (key.ToUpper().EndsWith("LEFTYAXISORIGINALGRAPHTYPE", StringComparison.Ordinal))
						{
							continue;
						}
						else if (key.ToUpper().EndsWith("RIGHTYAXISORIGINALGRAPHTYPE", StringComparison.Ordinal))
						{
							continue;
						}
					}
			...
			for (int iann = 0; iann < nann; iann++)
			{
				...
				for (int j = 0; j < dsize; j++)
				{
					...
					else if (!outputAll)
					{
						...
						if (key.Equals("AnnotationID", StringComparison.OrdinalIgnoreCase) || key.Equals("AnnotationTableID", StringComparison.OrdinalIgnoreCase) || key.Equals("Color", StringComparison.OrdinalIgnoreCase) || key.Equals("Order", StringComparison.OrdinalIgnoreCase) || key.Equals("ShapeType", StringComparison.OrdinalIgnoreCase) || key.Equals("XAxisSystem", StringComparison.OrdinalIgnoreCase) || key.Equals("YAxis", StringComparison.OrdinalIgnoreCase) || key.Equals("YAxisSystem", StringComparison.OrdinalIgnoreCase))
						{
							output = true;
						}
						else if (type.Equals("Line", StringComparison.OrdinalIgnoreCase))
						{
							if (key.Equals("LineStyle", StringComparison.OrdinalIgnoreCase) || key.Equals("LineWidth", StringComparison.OrdinalIgnoreCase) || key.Equals("Points", StringComparison.OrdinalIgnoreCase))
							{
								output = true;
							}
						}
						...
						{
							if (key.Equals("Point", StringComparison.OrdinalIgnoreCase) || key.Equals("SymbolPosition", StringComparison.OrdinalIgnoreCase) || key.Equals("SymbolSize", StringComparison.OrdinalIgnoreCase) || key.Equals("SymbolStyle", StringComparison.OrdinalIgnoreCase))
							{
								output = true;
							}
						}
						...
						{
							if (key.Equals("FontSize", StringComparison.OrdinalIgnoreCase) || key.Equals("FontStyle", StringComparison.OrdinalIgnoreCase) || key.Equals("FontName", StringComparison.OrdinalIgnoreCase) || key.Equals("Point", StringComparison.OrdinalIgnoreCase) || key.Equals("Text", StringComparison.OrdinalIgnoreCase) || key.Equals("TextPosition", StringComparison.OrdinalIgnoreCase))
							{
								output = true;
							}
						}
	...
	/// <summary>
	/// Unsets a property in the product with the given key. </summary>
	/// <param name="key"> the key of the property to unset. </param>
	protected internal virtual void unSet(string key)
	{
		__proplist.unSet(key);
	}
	...
	/// the new contents and comments will not be transferred. </summary>
	/// <param name="filename"> Name of file to save. </param>
	/// <param name="outputAll"> If true, all properties will be saved, even those that have been
	...
	/// minimum amount of information. </param>
	/// <exception cref="if"> there is an error writing the file. </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public void writeFile(String filename, boolean outputAll) throws Exception
	public virtual void writeFile(string filename, bool outputAll)
	{ // First convert the product to a string, currently always the legacy properties format
		bool outputHowSet = false; // only used for development
		bool sort = false; // Keep in-memory order
