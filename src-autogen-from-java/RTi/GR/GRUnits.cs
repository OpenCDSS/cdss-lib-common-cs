...
namespace RTi.GR
{
	...
	/// <summary>
	/// This class defines units for devices and drawing areas. </summary>
	...
	private const int UNIT_MIN = DEVICE;
	/// <summary>
	/// Data units
	/// Device default.
	/// </summary>
	...
	/// HPGL units.
	/// </summary>
	public const int HPGL = 3;
	/// <summary>
	/// Inch.
	/// </summary>
	public const int INCH = 4;
	/// <summary>
	/// Kilometers.
	/// </summary>
	...
	/// Points.
	/// </summary>
	public const int POINT = 9;
	/// <summary>
	/// Yards.
	/// </summary>
	public const int YARD = 10;
	/// <summary>
	/// The maximum unit type.
	/// </summary>
	private const int UNIT_MAX = YARD;
	...
	/// <summary>
	/// Converts from one unit type to another. </summary>
	/// <param name="x"> the value to convert. </param>
	/// <param name="from"> the units from which to convert </param>
	/// <param name="to"> the units to which to convert </param>
	/// <returns> the value in units of the converted value. </returns>
	public static double convert(double x, int from, int to)
	{
		...
		{
			Message.printWarning(3, routine, "\"from\" unit " + from + " is outside acceptable range (" + UNIT_MIN + "=" + _GRUnits_conversion_data[UNIT_MIN].abbreviation + ", " + UNIT_MAX + "=" + _GRUnits_conversion_data[UNIT_MAX].abbreviation + ")");
			return x;
		}
		if ((to < UNIT_MIN) || (to > UNIT_MAX))
		{
			Message.printWarning(3, routine, "\"to\" unit " + to + " is outside acceptable range (" + UNIT_MIN + "=" + _GRUnits_conversion_data[UNIT_MIN].abbreviation + ", " + UNIT_MAX + "=" + _GRUnits_conversion_data[UNIT_MAX].abbreviation + ")");
			return x;
		}
