...
namespace RTi.GIS.GeoView
{
	...
	/// on a map. </summary>
	/// <returns> the the GeoRecord to use for the object </returns>
	GeoRecord getGeoRecord();

	/// <summary>
	/// Set the GeoRecord associated with the object.  For example, this can be used to tag the object with
	/// spatial information, perhaps looked up from a geographic data layer via the object's identifier. </summary>
	/// <param name="geoRecord"> the GeoRecord to use for the object </param>
	void setGeoRecord(GeoRecord geoRecord);
