...
// CommandException - an Exception to be thrown when a command cannot be run due to a nonrecoverable problem
...
//ORIGINAL LINE: @SuppressWarnings("serial") public class CommandException extends Exception
