...
namespace RTi.Util.IO
{
	...
	/// <summary>
	/// Create a new Command instance based on the command string. </summary>
	/// <param name="command_string"> The full command string. </param>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public Command newCommand(String command_string) throws UnknownCommandException;
	Command newCommand(string command_string);
