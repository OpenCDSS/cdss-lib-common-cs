...
namespace RTi.Util.IO
{
	...
	using EventTimer = RTi.Util.GUI.EventTimer;
	...
	public ProcessManager(string command) : this(command, 0, null, true, (File)null)
	{
	}
	...
	public ProcessManager(string command, int timeoutMilliseconds) : this(command, timeoutMilliseconds, null, true, (File)null)
	{
	}
	...
	public ProcessManager(string command, int timeoutMilliseconds, string exitStatusIndicator, bool useCommandShell, File workingDir)
	{
	...
	/// specified, the PATH environment variable is used to find the executable,
	/// according to the operating system. </param>
	public ProcessManager(string[] command_array) : this(command_array, 0, (string)null, true, (File)null)
	{
	}
	...
	/// exit with a status of 999.  Specifying 0 will result in no timeout. </param>
	public ProcessManager(string[] command_array, int timeout_milliseconds) : this(command_array, timeout_milliseconds, (string)null, true, (File)null)
	{
	}
	...
	/// <summary>
	/// Handle the action event from the EventTimer. </summary>
	/// <param name="e"> ActionEvent </param>
	public virtual void actionPerformed(ActionEvent e)
	{
		if (e.getActionCommand().Equals("Timeout") && !__processFinished)
		{
			...
			Message.printWarning(2, "ProcessManager.actionPerformed", "Process has timed out after " + __timeoutMilliseconds + " milliseconds.");
	...
	/// <param name="listener"> ProcessListener to add. </param>
	public virtual void addProcessListener(ProcessListener listener)
...
//		base.finalize();
	...
	/// <summary>
	/// Return the command this is being executed. </summary>
	/// <returns> the command this is being executed. </returns>
	...
	/// <summary>
	/// Return the standard error of the process as a list of String. </summary>
	/// <returns> the standard error of the process as a list of String.
	/// If saveOutput(true) is called, this will be non-null.  Otherwise, it will be null. </returns>
	public virtual IList<string> getErrorList()
	{
		return __errorList;
	}
	...
	/// retrieve the streams for the process. </summary>
	...
	/// process has terminated normally or an error has occurred. </summary>
	/// <returns> true if the process has finished running, false if not. </returns>
	public virtual bool isProcessFinished()
	{
	...
	/// it was registered multiple times. </summary>
	/// <param name="listener"> ProcessListener to remove. </param>
	public virtual void removeProcessListener(ProcessListener listener)
	{
		if (listener == null)
		{
			return;
	...
	/// The default is not to save the output. </summary>
	/// <param name="save_output"> Indicates whether the output from the command should be saved. </param>
	public virtual void saveOutput(bool save_output)
	{
	...
	/// UNIX/Linux:  /bin/sh -c
	/// </pre> </summary>
	/// <param name="interpreter"> The command interpreter separated into separate String
	/// tokens.  If no interpreter is desired, specify a null array. </param>
	public virtual void setCommandInterpreter(string[] interpreter)
	{
		string routine = this.GetType().Name + ".setCommandInterpreter";
		...
		if (interpreter == null)
		{
			...
			Message.printStatus(2, routine, "Command interpreter will not be used because calling code has " + "set the interpreter string to null.");
		}
		else
		{
	...
	/// <summary>
	/// Set the environment variables to be used by the run. </summary>
	/// <param name="the"> map of environment variables to set for the run.  Specify the value with a + as the first
	/// character to append to the existing value, or no + to set to the specified value. </param>
	public virtual void setEnvironment(IDictionary<string, string> env)
	{
	...
	/// </summary>
	private void setErrorList(IList<string> errorList)
	{
	...
	public virtual void setProcessFinished(int exitValue, string exitMessage)
	{
		...
		Message.printStatus(__processStatusLevel, "ProcessManager.setProcessFinished", "Process took " + StringUtil.formatString(__stopwatch.getSeconds(),"%.3f") + " seconds.");
		// Call the listeners...
		if (__listeners != null)
		{
	...
	/// run.  The default is status level 1. </summary>
	/// <param name="level"> the level at which ProcessManager's messages should be printed during a run. </param>
	public virtual void setRunStatusLevel(int level)
	{
