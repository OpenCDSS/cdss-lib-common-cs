...
// UnknownCommandException - an Exception to be thrown when a command name is not recognized
...
//ORIGINAL LINE: @SuppressWarnings("serial") public class UnknownCommandException extends Exception
