...
namespace RTi.Util.Message
{
	...
	/// request (e.g., selecting a command or component in the main application). </summary>
	/// <param name="tag"> the tag associated with a message, as used in messages. </param>
	void goToMessageTag(string tag);
